   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  28:	ff 35 9c 0a 00 00    	push   0xa9c
  2e:	e8 fd 03 00 00       	call   430 <printf>
    exit();
  ...
  4a:	68 74 07 00 00       	push   $0x774
  4f:	ff 35 a0 0a 00 00    	push   0xaa0
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 93 07 00 00       	mov    $0x793,%edx
        while(*s != 0){
