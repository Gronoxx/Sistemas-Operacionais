...
80100505:	e8 d6 57 00 00       	call   80105ce0 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 ca 57 00 00       	call   80105ce0 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 be 57 00 00       	call   80105ce0 <uartputc>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 37 63 00 00       	call   80106e70 <setupkvm>
...
80100ba3:	e8 e8 60 00 00       	call   80106c90 <allocuvm>
...
80100bd9:	e8 c2 5f 00 00       	call   80106ba0 <loaduvm>
...
80100c1b:	e8 d0 61 00 00       	call   80106df0 <freevm>
  if(ip){
...
80100cf8:	e8 e3 63 00 00       	call   801070e0 <copyout>
...
80100d11:	e8 da 60 00 00       	call   80106df0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 78 63 00 00       	call   801070e0 <copyout>
...
80100dcd:	e8 3e 5c 00 00       	call   80106a10 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 16 60 00 00       	call   80106df0 <freevm>
  return 0;
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 b5 39 00 00       	call   80106a00 <switchkvm>
  seginit();
8010304b:	e8 20 39 00 00       	call   80106970 <seginit>
  lapicinit();
...
80103081:	e8 6a 3e 00 00       	call   80106ef0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 db 38 00 00       	call   80106970 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 57 2b 00 00       	call   80105c00 <uartinit>
  pinit();         // process table
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 78 58 10 80 	movl   $0x80105878,0x14(%eax)
  p->context = (struct context*)sp;
...
801039b3:	e8 b8 34 00 00       	call   80106e70 <setupkvm>
...
801039d1:	e8 4a 31 00 00       	call   80106b20 <inituvm>
...
80103abb:	e8 50 2f 00 00       	call   80106a10 <switchuvm>
  return 0;
...
80103b48:	e8 13 34 00 00       	call   80106f60 <copyuvm>
...
80103f89:	e8 62 2e 00 00       	call   80106df0 <freevm>
        p->pid = 0;
...
80105857:	e8 74 d1 ff ff       	call   801029d0 <cmostime>
...
80105861:	06                   	push   %es
  pushl %fs
80105862:	0f a0                	push   %fs
  pushl %gs
80105864:	0f a8                	push   %gs
  pushal
80105866:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105867:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010586b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010586d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010586f:	54                   	push   %esp
  call trap
80105870:	e8 cb 00 00 00       	call   80105940 <trap>
  addl $4, %esp
80105875:	83 c4 04             	add    $0x4,%esp
...
80105878:	61                   	popa   
  popl %gs
80105879:	0f a9                	pop    %gs
  popl %fs
8010587b:	0f a1                	pop    %fs
  popl %es
8010587d:	07                   	pop    %es
  popl %ds
8010587e:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010587f:	83 c4 08             	add    $0x8,%esp
  iret
80105882:	cf                   	iret   
...
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 3d 79 10 80       	push   $0x8010793d
...
80105964:	ff 24 85 e4 79 10 80 	jmp    *-0x7fef861c(,%eax,4)
...
801059fa:	0f 84 a2 01 00 00    	je     80105ba2 <trap+0x262>
80105a00:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a04:	0f 84 98 01 00 00    	je     80105ba2 <trap+0x262>
...
80105a10:	e8 3b df ff ff       	call   80103950 <cpuid>
...
80105a45:	68 a0 79 10 80       	push   $0x801079a0
80105a4a:	e8 51 ac ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105a4f:	83 c4 20             	add    $0x20,%esp
80105a52:	e8 19 df ff ff       	call   80103970 <myproc>
80105a57:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a5e:	e8 0d df ff ff       	call   80103970 <myproc>
80105a63:	85 c0                	test   %eax,%eax
80105a65:	0f 85 18 ff ff ff    	jne    80105983 <trap+0x43>
80105a6b:	e9 30 ff ff ff       	jmp    801059a0 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
...
80105a97:	68 48 79 10 80       	push   $0x80107948
...
80105aca:	0f 85 c8 00 00 00    	jne    80105b98 <trap+0x258>
    myproc()->tf = tf;
...
80105af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b00:	e8 3b 02 00 00       	call   80105d40 <uartintr>
    lapiceoi();
...
80105b9d:	e9 2e ff ff ff       	jmp    80105ad0 <trap+0x190>
80105ba2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ba5:	e8 a6 dd ff ff       	call   80103950 <cpuid>
80105baa:	83 ec 0c             	sub    $0xc,%esp
80105bad:	56                   	push   %esi
80105bae:	57                   	push   %edi
80105baf:	50                   	push   %eax
80105bb0:	ff 73 30             	push   0x30(%ebx)
80105bb3:	68 6c 79 10 80       	push   $0x8010796c
80105bb8:	e8 e3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bbd:	83 c4 14             	add    $0x14,%esp
80105bc0:	68 42 79 10 80       	push   $0x80107942
...
80105c57:	74 78                	je     80105cd1 <uartinit+0xd1>
  uart = 1;
80105c59:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105c60:	00 00 00 
...
80105c6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c6f:	bf 64 7a 10 80       	mov    $0x80107a64,%edi
80105c74:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105c79:	6a 00                	push   $0x0
80105c7b:	6a 04                	push   $0x4
80105c7d:	e8 fe c7 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105c82:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
...
80105c95:	bb 80 00 00 00       	mov    $0x80,%ebx
80105c9a:	85 c0                	test   %eax,%eax
80105c9c:	75 14                	jne    80105cb2 <uartinit+0xb2>
80105c9e:	eb 23                	jmp    80105cc3 <uartinit+0xc3>
    microdelay(10);
80105ca0:	83 ec 0c             	sub    $0xc,%esp
80105ca3:	6a 0a                	push   $0xa
80105ca5:	e8 86 cc ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105caa:	83 c4 10             	add    $0x10,%esp
80105cad:	83 eb 01             	sub    $0x1,%ebx
80105cb0:	74 07                	je     80105cb9 <uartinit+0xb9>
80105cb2:	89 f2                	mov    %esi,%edx
80105cb4:	ec                   	in     (%dx),%al
80105cb5:	a8 20                	test   $0x20,%al
80105cb7:	74 e7                	je     80105ca0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105cb9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105cbd:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105cc2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105cc3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105cc7:	83 c7 01             	add    $0x1,%edi
80105cca:	88 45 e7             	mov    %al,-0x19(%ebp)
80105ccd:	84 c0                	test   %al,%al
80105ccf:	75 bf                	jne    80105c90 <uartinit+0x90>
}
...
80105ce7:	74 47                	je     80105d30 <uartputc+0x50>
{
...
80105cf3:	bb 80 00 00 00       	mov    $0x80,%ebx
80105cf8:	eb 18                	jmp    80105d12 <uartputc+0x32>
...
80105d10:	74 07                	je     80105d19 <uartputc+0x39>
80105d12:	89 f2                	mov    %esi,%edx
80105d14:	ec                   	in     (%dx),%al
80105d15:	a8 20                	test   $0x20,%al
80105d17:	74 e7                	je     80105d00 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105d19:	8b 45 08             	mov    0x8(%ebp),%eax
80105d1c:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105d4b:	e8 30 ab ff ff       	call   80100880 <consoleintr>
}
...
80105d57:	6a 00                	push   $0x0
  jmp alltraps
80105d59:	e9 02 fb ff ff       	jmp    80105860 <alltraps>
...
80105d60:	6a 01                	push   $0x1
  jmp alltraps
80105d62:	e9 f9 fa ff ff       	jmp    80105860 <alltraps>
...
80105d69:	6a 02                	push   $0x2
  jmp alltraps
80105d6b:	e9 f0 fa ff ff       	jmp    80105860 <alltraps>
...
80105d72:	6a 03                	push   $0x3
  jmp alltraps
80105d74:	e9 e7 fa ff ff       	jmp    80105860 <alltraps>
...
80105d7b:	6a 04                	push   $0x4
  jmp alltraps
80105d7d:	e9 de fa ff ff       	jmp    80105860 <alltraps>
...
80105d84:	6a 05                	push   $0x5
  jmp alltraps
80105d86:	e9 d5 fa ff ff       	jmp    80105860 <alltraps>
...
80105d8d:	6a 06                	push   $0x6
  jmp alltraps
80105d8f:	e9 cc fa ff ff       	jmp    80105860 <alltraps>
...
80105d96:	6a 07                	push   $0x7
  jmp alltraps
80105d98:	e9 c3 fa ff ff       	jmp    80105860 <alltraps>
...
80105d9d:	6a 08                	push   $0x8
  jmp alltraps
80105d9f:	e9 bc fa ff ff       	jmp    80105860 <alltraps>
...
80105da6:	6a 09                	push   $0x9
  jmp alltraps
80105da8:	e9 b3 fa ff ff       	jmp    80105860 <alltraps>
...
80105dad:	6a 0a                	push   $0xa
  jmp alltraps
80105daf:	e9 ac fa ff ff       	jmp    80105860 <alltraps>
...
80105db4:	6a 0b                	push   $0xb
  jmp alltraps
80105db6:	e9 a5 fa ff ff       	jmp    80105860 <alltraps>
...
80105dbb:	6a 0c                	push   $0xc
  jmp alltraps
80105dbd:	e9 9e fa ff ff       	jmp    80105860 <alltraps>
...
80105dc2:	6a 0d                	push   $0xd
  jmp alltraps
80105dc4:	e9 97 fa ff ff       	jmp    80105860 <alltraps>
...
80105dc9:	6a 0e                	push   $0xe
  jmp alltraps
80105dcb:	e9 90 fa ff ff       	jmp    80105860 <alltraps>
...
80105dd2:	6a 0f                	push   $0xf
  jmp alltraps
80105dd4:	e9 87 fa ff ff       	jmp    80105860 <alltraps>
...
80105ddb:	6a 10                	push   $0x10
  jmp alltraps
80105ddd:	e9 7e fa ff ff       	jmp    80105860 <alltraps>
...
80105de2:	6a 11                	push   $0x11
  jmp alltraps
80105de4:	e9 77 fa ff ff       	jmp    80105860 <alltraps>
...
80105deb:	6a 12                	push   $0x12
  jmp alltraps
80105ded:	e9 6e fa ff ff       	jmp    80105860 <alltraps>
...
80105df4:	6a 13                	push   $0x13
  jmp alltraps
80105df6:	e9 65 fa ff ff       	jmp    80105860 <alltraps>
...
80105dfd:	6a 14                	push   $0x14
  jmp alltraps
80105dff:	e9 5c fa ff ff       	jmp    80105860 <alltraps>
...
80105e06:	6a 15                	push   $0x15
  jmp alltraps
80105e08:	e9 53 fa ff ff       	jmp    80105860 <alltraps>
...
80105e0f:	6a 16                	push   $0x16
  jmp alltraps
80105e11:	e9 4a fa ff ff       	jmp    80105860 <alltraps>
...
80105e18:	6a 17                	push   $0x17
  jmp alltraps
80105e1a:	e9 41 fa ff ff       	jmp    80105860 <alltraps>
...
80105e21:	6a 18                	push   $0x18
  jmp alltraps
80105e23:	e9 38 fa ff ff       	jmp    80105860 <alltraps>
...
80105e2a:	6a 19                	push   $0x19
  jmp alltraps
80105e2c:	e9 2f fa ff ff       	jmp    80105860 <alltraps>
...
80105e33:	6a 1a                	push   $0x1a
  jmp alltraps
80105e35:	e9 26 fa ff ff       	jmp    80105860 <alltraps>
...
80105e3c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e3e:	e9 1d fa ff ff       	jmp    80105860 <alltraps>
...
80105e45:	6a 1c                	push   $0x1c
  jmp alltraps
80105e47:	e9 14 fa ff ff       	jmp    80105860 <alltraps>
...
80105e4e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e50:	e9 0b fa ff ff       	jmp    80105860 <alltraps>
...
80105e57:	6a 1e                	push   $0x1e
  jmp alltraps
80105e59:	e9 02 fa ff ff       	jmp    80105860 <alltraps>
...
80105e60:	6a 1f                	push   $0x1f
  jmp alltraps
80105e62:	e9 f9 f9 ff ff       	jmp    80105860 <alltraps>
...
80105e69:	6a 20                	push   $0x20
  jmp alltraps
80105e6b:	e9 f0 f9 ff ff       	jmp    80105860 <alltraps>
...
80105e72:	6a 21                	push   $0x21
  jmp alltraps
80105e74:	e9 e7 f9 ff ff       	jmp    80105860 <alltraps>
...
80105e7b:	6a 22                	push   $0x22
  jmp alltraps
80105e7d:	e9 de f9 ff ff       	jmp    80105860 <alltraps>
...
80105e84:	6a 23                	push   $0x23
  jmp alltraps
80105e86:	e9 d5 f9 ff ff       	jmp    80105860 <alltraps>
...
80105e8d:	6a 24                	push   $0x24
  jmp alltraps
80105e8f:	e9 cc f9 ff ff       	jmp    80105860 <alltraps>
...
80105e96:	6a 25                	push   $0x25
  jmp alltraps
80105e98:	e9 c3 f9 ff ff       	jmp    80105860 <alltraps>
...
80105e9f:	6a 26                	push   $0x26
  jmp alltraps
80105ea1:	e9 ba f9 ff ff       	jmp    80105860 <alltraps>
...
80105ea8:	6a 27                	push   $0x27
  jmp alltraps
80105eaa:	e9 b1 f9 ff ff       	jmp    80105860 <alltraps>
...
80105eb1:	6a 28                	push   $0x28
  jmp alltraps
80105eb3:	e9 a8 f9 ff ff       	jmp    80105860 <alltraps>
...
80105eba:	6a 29                	push   $0x29
  jmp alltraps
80105ebc:	e9 9f f9 ff ff       	jmp    80105860 <alltraps>
...
80105ec3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ec5:	e9 96 f9 ff ff       	jmp    80105860 <alltraps>
...
80105ecc:	6a 2b                	push   $0x2b
  jmp alltraps
80105ece:	e9 8d f9 ff ff       	jmp    80105860 <alltraps>
...
80105ed5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ed7:	e9 84 f9 ff ff       	jmp    80105860 <alltraps>
...
80105ede:	6a 2d                	push   $0x2d
  jmp alltraps
80105ee0:	e9 7b f9 ff ff       	jmp    80105860 <alltraps>
...
80105ee7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ee9:	e9 72 f9 ff ff       	jmp    80105860 <alltraps>
...
80105ef0:	6a 2f                	push   $0x2f
  jmp alltraps
80105ef2:	e9 69 f9 ff ff       	jmp    80105860 <alltraps>
...
80105ef9:	6a 30                	push   $0x30
  jmp alltraps
80105efb:	e9 60 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f02:	6a 31                	push   $0x31
  jmp alltraps
80105f04:	e9 57 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f0b:	6a 32                	push   $0x32
  jmp alltraps
80105f0d:	e9 4e f9 ff ff       	jmp    80105860 <alltraps>
...
80105f14:	6a 33                	push   $0x33
  jmp alltraps
80105f16:	e9 45 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f1d:	6a 34                	push   $0x34
  jmp alltraps
80105f1f:	e9 3c f9 ff ff       	jmp    80105860 <alltraps>
...
80105f26:	6a 35                	push   $0x35
  jmp alltraps
80105f28:	e9 33 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f2f:	6a 36                	push   $0x36
  jmp alltraps
80105f31:	e9 2a f9 ff ff       	jmp    80105860 <alltraps>
...
80105f38:	6a 37                	push   $0x37
  jmp alltraps
80105f3a:	e9 21 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f41:	6a 38                	push   $0x38
  jmp alltraps
80105f43:	e9 18 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f4a:	6a 39                	push   $0x39
  jmp alltraps
80105f4c:	e9 0f f9 ff ff       	jmp    80105860 <alltraps>
...
80105f53:	6a 3a                	push   $0x3a
  jmp alltraps
80105f55:	e9 06 f9 ff ff       	jmp    80105860 <alltraps>
...
80105f5c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f5e:	e9 fd f8 ff ff       	jmp    80105860 <alltraps>
...
80105f65:	6a 3c                	push   $0x3c
  jmp alltraps
80105f67:	e9 f4 f8 ff ff       	jmp    80105860 <alltraps>
...
80105f6e:	6a 3d                	push   $0x3d
  jmp alltraps
80105f70:	e9 eb f8 ff ff       	jmp    80105860 <alltraps>
...
80105f77:	6a 3e                	push   $0x3e
  jmp alltraps
80105f79:	e9 e2 f8 ff ff       	jmp    80105860 <alltraps>
...
80105f80:	6a 3f                	push   $0x3f
  jmp alltraps
80105f82:	e9 d9 f8 ff ff       	jmp    80105860 <alltraps>
...
80105f89:	6a 40                	push   $0x40
  jmp alltraps
80105f8b:	e9 d0 f8 ff ff       	jmp    80105860 <alltraps>
...
80105f92:	6a 41                	push   $0x41
  jmp alltraps
80105f94:	e9 c7 f8 ff ff       	jmp    80105860 <alltraps>
...
80105f9b:	6a 42                	push   $0x42
  jmp alltraps
80105f9d:	e9 be f8 ff ff       	jmp    80105860 <alltraps>
...
80105fa4:	6a 43                	push   $0x43
  jmp alltraps
80105fa6:	e9 b5 f8 ff ff       	jmp    80105860 <alltraps>
...
80105fad:	6a 44                	push   $0x44
  jmp alltraps
80105faf:	e9 ac f8 ff ff       	jmp    80105860 <alltraps>
...
80105fb6:	6a 45                	push   $0x45
  jmp alltraps
80105fb8:	e9 a3 f8 ff ff       	jmp    80105860 <alltraps>
...
80105fbf:	6a 46                	push   $0x46
  jmp alltraps
80105fc1:	e9 9a f8 ff ff       	jmp    80105860 <alltraps>
...
80105fc8:	6a 47                	push   $0x47
  jmp alltraps
80105fca:	e9 91 f8 ff ff       	jmp    80105860 <alltraps>
...
80105fd1:	6a 48                	push   $0x48
  jmp alltraps
80105fd3:	e9 88 f8 ff ff       	jmp    80105860 <alltraps>
...
80105fda:	6a 49                	push   $0x49
  jmp alltraps
80105fdc:	e9 7f f8 ff ff       	jmp    80105860 <alltraps>
...
80105fe3:	6a 4a                	push   $0x4a
  jmp alltraps
80105fe5:	e9 76 f8 ff ff       	jmp    80105860 <alltraps>
...
80105fec:	6a 4b                	push   $0x4b
  jmp alltraps
80105fee:	e9 6d f8 ff ff       	jmp    80105860 <alltraps>
...
80105ff5:	6a 4c                	push   $0x4c
  jmp alltraps
80105ff7:	e9 64 f8 ff ff       	jmp    80105860 <alltraps>
...
80105ffe:	6a 4d                	push   $0x4d
  jmp alltraps
80106000:	e9 5b f8 ff ff       	jmp    80105860 <alltraps>
...
80106007:	6a 4e                	push   $0x4e
  jmp alltraps
80106009:	e9 52 f8 ff ff       	jmp    80105860 <alltraps>
...
80106010:	6a 4f                	push   $0x4f
  jmp alltraps
80106012:	e9 49 f8 ff ff       	jmp    80105860 <alltraps>
...
80106019:	6a 50                	push   $0x50
  jmp alltraps
8010601b:	e9 40 f8 ff ff       	jmp    80105860 <alltraps>
...
80106022:	6a 51                	push   $0x51
  jmp alltraps
80106024:	e9 37 f8 ff ff       	jmp    80105860 <alltraps>
...
8010602b:	6a 52                	push   $0x52
  jmp alltraps
8010602d:	e9 2e f8 ff ff       	jmp    80105860 <alltraps>
...
80106034:	6a 53                	push   $0x53
  jmp alltraps
80106036:	e9 25 f8 ff ff       	jmp    80105860 <alltraps>
...
8010603d:	6a 54                	push   $0x54
  jmp alltraps
8010603f:	e9 1c f8 ff ff       	jmp    80105860 <alltraps>
...
80106046:	6a 55                	push   $0x55
  jmp alltraps
80106048:	e9 13 f8 ff ff       	jmp    80105860 <alltraps>
...
8010604f:	6a 56                	push   $0x56
  jmp alltraps
80106051:	e9 0a f8 ff ff       	jmp    80105860 <alltraps>
...
80106058:	6a 57                	push   $0x57
  jmp alltraps
8010605a:	e9 01 f8 ff ff       	jmp    80105860 <alltraps>
...
80106061:	6a 58                	push   $0x58
  jmp alltraps
80106063:	e9 f8 f7 ff ff       	jmp    80105860 <alltraps>
...
8010606a:	6a 59                	push   $0x59
  jmp alltraps
8010606c:	e9 ef f7 ff ff       	jmp    80105860 <alltraps>
...
80106073:	6a 5a                	push   $0x5a
  jmp alltraps
80106075:	e9 e6 f7 ff ff       	jmp    80105860 <alltraps>
...
8010607c:	6a 5b                	push   $0x5b
  jmp alltraps
8010607e:	e9 dd f7 ff ff       	jmp    80105860 <alltraps>
...
80106085:	6a 5c                	push   $0x5c
  jmp alltraps
80106087:	e9 d4 f7 ff ff       	jmp    80105860 <alltraps>
...
8010608e:	6a 5d                	push   $0x5d
  jmp alltraps
80106090:	e9 cb f7 ff ff       	jmp    80105860 <alltraps>
...
80106097:	6a 5e                	push   $0x5e
  jmp alltraps
80106099:	e9 c2 f7 ff ff       	jmp    80105860 <alltraps>
...
801060a0:	6a 5f                	push   $0x5f
  jmp alltraps
801060a2:	e9 b9 f7 ff ff       	jmp    80105860 <alltraps>
...
801060a9:	6a 60                	push   $0x60
  jmp alltraps
801060ab:	e9 b0 f7 ff ff       	jmp    80105860 <alltraps>
...
801060b2:	6a 61                	push   $0x61
  jmp alltraps
801060b4:	e9 a7 f7 ff ff       	jmp    80105860 <alltraps>
...
801060bb:	6a 62                	push   $0x62
  jmp alltraps
801060bd:	e9 9e f7 ff ff       	jmp    80105860 <alltraps>
...
801060c4:	6a 63                	push   $0x63
  jmp alltraps
801060c6:	e9 95 f7 ff ff       	jmp    80105860 <alltraps>
...
801060cd:	6a 64                	push   $0x64
  jmp alltraps
801060cf:	e9 8c f7 ff ff       	jmp    80105860 <alltraps>
...
801060d6:	6a 65                	push   $0x65
  jmp alltraps
801060d8:	e9 83 f7 ff ff       	jmp    80105860 <alltraps>
...
801060df:	6a 66                	push   $0x66
  jmp alltraps
801060e1:	e9 7a f7 ff ff       	jmp    80105860 <alltraps>
...
801060e8:	6a 67                	push   $0x67
  jmp alltraps
801060ea:	e9 71 f7 ff ff       	jmp    80105860 <alltraps>
...
801060f1:	6a 68                	push   $0x68
  jmp alltraps
801060f3:	e9 68 f7 ff ff       	jmp    80105860 <alltraps>
...
801060fa:	6a 69                	push   $0x69
  jmp alltraps
801060fc:	e9 5f f7 ff ff       	jmp    80105860 <alltraps>
...
80106103:	6a 6a                	push   $0x6a
  jmp alltraps
80106105:	e9 56 f7 ff ff       	jmp    80105860 <alltraps>
...
8010610c:	6a 6b                	push   $0x6b
  jmp alltraps
8010610e:	e9 4d f7 ff ff       	jmp    80105860 <alltraps>
...
80106115:	6a 6c                	push   $0x6c
  jmp alltraps
80106117:	e9 44 f7 ff ff       	jmp    80105860 <alltraps>
...
8010611e:	6a 6d                	push   $0x6d
  jmp alltraps
80106120:	e9 3b f7 ff ff       	jmp    80105860 <alltraps>
...
80106127:	6a 6e                	push   $0x6e
  jmp alltraps
80106129:	e9 32 f7 ff ff       	jmp    80105860 <alltraps>
...
80106130:	6a 6f                	push   $0x6f
  jmp alltraps
80106132:	e9 29 f7 ff ff       	jmp    80105860 <alltraps>
...
80106139:	6a 70                	push   $0x70
  jmp alltraps
8010613b:	e9 20 f7 ff ff       	jmp    80105860 <alltraps>
...
80106142:	6a 71                	push   $0x71
  jmp alltraps
80106144:	e9 17 f7 ff ff       	jmp    80105860 <alltraps>
...
8010614b:	6a 72                	push   $0x72
  jmp alltraps
8010614d:	e9 0e f7 ff ff       	jmp    80105860 <alltraps>
...
80106154:	6a 73                	push   $0x73
  jmp alltraps
80106156:	e9 05 f7 ff ff       	jmp    80105860 <alltraps>
...
8010615d:	6a 74                	push   $0x74
  jmp alltraps
8010615f:	e9 fc f6 ff ff       	jmp    80105860 <alltraps>
...
80106166:	6a 75                	push   $0x75
  jmp alltraps
80106168:	e9 f3 f6 ff ff       	jmp    80105860 <alltraps>
...
8010616f:	6a 76                	push   $0x76
  jmp alltraps
80106171:	e9 ea f6 ff ff       	jmp    80105860 <alltraps>
...
80106178:	6a 77                	push   $0x77
  jmp alltraps
8010617a:	e9 e1 f6 ff ff       	jmp    80105860 <alltraps>
...
80106181:	6a 78                	push   $0x78
  jmp alltraps
80106183:	e9 d8 f6 ff ff       	jmp    80105860 <alltraps>
...
8010618a:	6a 79                	push   $0x79
  jmp alltraps
8010618c:	e9 cf f6 ff ff       	jmp    80105860 <alltraps>
...
80106193:	6a 7a                	push   $0x7a
  jmp alltraps
80106195:	e9 c6 f6 ff ff       	jmp    80105860 <alltraps>
...
8010619c:	6a 7b                	push   $0x7b
  jmp alltraps
8010619e:	e9 bd f6 ff ff       	jmp    80105860 <alltraps>
...
801061a5:	6a 7c                	push   $0x7c
  jmp alltraps
801061a7:	e9 b4 f6 ff ff       	jmp    80105860 <alltraps>
...
801061ae:	6a 7d                	push   $0x7d
  jmp alltraps
801061b0:	e9 ab f6 ff ff       	jmp    80105860 <alltraps>
...
801061b7:	6a 7e                	push   $0x7e
  jmp alltraps
801061b9:	e9 a2 f6 ff ff       	jmp    80105860 <alltraps>
...
801061c0:	6a 7f                	push   $0x7f
  jmp alltraps
801061c2:	e9 99 f6 ff ff       	jmp    80105860 <alltraps>
...
801061c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061ce:	e9 8d f6 ff ff       	jmp    80105860 <alltraps>
...
801061d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801061da:	e9 81 f6 ff ff       	jmp    80105860 <alltraps>
...
801061e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061e6:	e9 75 f6 ff ff       	jmp    80105860 <alltraps>
...
801061ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801061f2:	e9 69 f6 ff ff       	jmp    80105860 <alltraps>
...
801061f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801061fe:	e9 5d f6 ff ff       	jmp    80105860 <alltraps>
...
80106205:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010620a:	e9 51 f6 ff ff       	jmp    80105860 <alltraps>
...
80106211:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106216:	e9 45 f6 ff ff       	jmp    80105860 <alltraps>
...
8010621d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106222:	e9 39 f6 ff ff       	jmp    80105860 <alltraps>
...
80106229:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010622e:	e9 2d f6 ff ff       	jmp    80105860 <alltraps>
...
80106235:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010623a:	e9 21 f6 ff ff       	jmp    80105860 <alltraps>
...
80106241:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106246:	e9 15 f6 ff ff       	jmp    80105860 <alltraps>
...
8010624d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106252:	e9 09 f6 ff ff       	jmp    80105860 <alltraps>
...
80106259:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010625e:	e9 fd f5 ff ff       	jmp    80105860 <alltraps>
...
80106265:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010626a:	e9 f1 f5 ff ff       	jmp    80105860 <alltraps>
...
80106271:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106276:	e9 e5 f5 ff ff       	jmp    80105860 <alltraps>
...
8010627d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106282:	e9 d9 f5 ff ff       	jmp    80105860 <alltraps>
...
80106289:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010628e:	e9 cd f5 ff ff       	jmp    80105860 <alltraps>
...
80106295:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010629a:	e9 c1 f5 ff ff       	jmp    80105860 <alltraps>
...
801062a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062a6:	e9 b5 f5 ff ff       	jmp    80105860 <alltraps>
...
801062ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062b2:	e9 a9 f5 ff ff       	jmp    80105860 <alltraps>
...
801062b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062be:	e9 9d f5 ff ff       	jmp    80105860 <alltraps>
...
801062c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062ca:	e9 91 f5 ff ff       	jmp    80105860 <alltraps>
...
801062d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801062d6:	e9 85 f5 ff ff       	jmp    80105860 <alltraps>
...
801062dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062e2:	e9 79 f5 ff ff       	jmp    80105860 <alltraps>
...
801062e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062ee:	e9 6d f5 ff ff       	jmp    80105860 <alltraps>
...
801062f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801062fa:	e9 61 f5 ff ff       	jmp    80105860 <alltraps>
...
80106301:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106306:	e9 55 f5 ff ff       	jmp    80105860 <alltraps>
...
8010630d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106312:	e9 49 f5 ff ff       	jmp    80105860 <alltraps>
...
80106319:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010631e:	e9 3d f5 ff ff       	jmp    80105860 <alltraps>
...
80106325:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010632a:	e9 31 f5 ff ff       	jmp    80105860 <alltraps>
...
80106331:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106336:	e9 25 f5 ff ff       	jmp    80105860 <alltraps>
...
8010633d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106342:	e9 19 f5 ff ff       	jmp    80105860 <alltraps>
...
80106349:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010634e:	e9 0d f5 ff ff       	jmp    80105860 <alltraps>
...
80106355:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010635a:	e9 01 f5 ff ff       	jmp    80105860 <alltraps>
...
80106361:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106366:	e9 f5 f4 ff ff       	jmp    80105860 <alltraps>
...
8010636d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106372:	e9 e9 f4 ff ff       	jmp    80105860 <alltraps>
...
80106379:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010637e:	e9 dd f4 ff ff       	jmp    80105860 <alltraps>
...
80106385:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010638a:	e9 d1 f4 ff ff       	jmp    80105860 <alltraps>
...
80106391:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106396:	e9 c5 f4 ff ff       	jmp    80105860 <alltraps>
...
8010639d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063a2:	e9 b9 f4 ff ff       	jmp    80105860 <alltraps>
...
801063a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063ae:	e9 ad f4 ff ff       	jmp    80105860 <alltraps>
...
801063b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063ba:	e9 a1 f4 ff ff       	jmp    80105860 <alltraps>
...
801063c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063c6:	e9 95 f4 ff ff       	jmp    80105860 <alltraps>
...
801063cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801063d2:	e9 89 f4 ff ff       	jmp    80105860 <alltraps>
...
801063d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063de:	e9 7d f4 ff ff       	jmp    80105860 <alltraps>
...
801063e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063ea:	e9 71 f4 ff ff       	jmp    80105860 <alltraps>
...
801063f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801063f6:	e9 65 f4 ff ff       	jmp    80105860 <alltraps>
...
801063fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106402:	e9 59 f4 ff ff       	jmp    80105860 <alltraps>
...
80106409:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010640e:	e9 4d f4 ff ff       	jmp    80105860 <alltraps>
...
80106415:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010641a:	e9 41 f4 ff ff       	jmp    80105860 <alltraps>
...
80106421:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106426:	e9 35 f4 ff ff       	jmp    80105860 <alltraps>
...
8010642d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106432:	e9 29 f4 ff ff       	jmp    80105860 <alltraps>
...
80106439:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010643e:	e9 1d f4 ff ff       	jmp    80105860 <alltraps>
...
80106445:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010644a:	e9 11 f4 ff ff       	jmp    80105860 <alltraps>
...
80106451:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106456:	e9 05 f4 ff ff       	jmp    80105860 <alltraps>
...
8010645d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106462:	e9 f9 f3 ff ff       	jmp    80105860 <alltraps>
...
80106469:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010646e:	e9 ed f3 ff ff       	jmp    80105860 <alltraps>
...
80106475:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010647a:	e9 e1 f3 ff ff       	jmp    80105860 <alltraps>
...
80106481:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106486:	e9 d5 f3 ff ff       	jmp    80105860 <alltraps>
...
8010648d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106492:	e9 c9 f3 ff ff       	jmp    80105860 <alltraps>
...
80106499:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010649e:	e9 bd f3 ff ff       	jmp    80105860 <alltraps>
...
801064a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064aa:	e9 b1 f3 ff ff       	jmp    80105860 <alltraps>
...
801064b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064b6:	e9 a5 f3 ff ff       	jmp    80105860 <alltraps>
...
801064bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064c2:	e9 99 f3 ff ff       	jmp    80105860 <alltraps>
...
801064c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064ce:	e9 8d f3 ff ff       	jmp    80105860 <alltraps>
...
801064d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801064da:	e9 81 f3 ff ff       	jmp    80105860 <alltraps>
...
801064e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064e6:	e9 75 f3 ff ff       	jmp    80105860 <alltraps>
...
801064ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801064f2:	e9 69 f3 ff ff       	jmp    80105860 <alltraps>
...
801064f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801064fe:	e9 5d f3 ff ff       	jmp    80105860 <alltraps>
...
80106505:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010650a:	e9 51 f3 ff ff       	jmp    80105860 <alltraps>
...
80106511:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106516:	e9 45 f3 ff ff       	jmp    80105860 <alltraps>
...
8010651d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106522:	e9 39 f3 ff ff       	jmp    80105860 <alltraps>
...
80106529:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010652e:	e9 2d f3 ff ff       	jmp    80105860 <alltraps>
...
80106535:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010653a:	e9 21 f3 ff ff       	jmp    80105860 <alltraps>
...
80106541:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106546:	e9 15 f3 ff ff       	jmp    80105860 <alltraps>
...
8010654d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106552:	e9 09 f3 ff ff       	jmp    80105860 <alltraps>
...
80106559:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010655e:	e9 fd f2 ff ff       	jmp    80105860 <alltraps>
...
80106565:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010656a:	e9 f1 f2 ff ff       	jmp    80105860 <alltraps>
...
80106571:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106576:	e9 e5 f2 ff ff       	jmp    80105860 <alltraps>
...
8010657d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106582:	e9 d9 f2 ff ff       	jmp    80105860 <alltraps>
...
80106589:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010658e:	e9 cd f2 ff ff       	jmp    80105860 <alltraps>
...
80106595:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010659a:	e9 c1 f2 ff ff       	jmp    80105860 <alltraps>
...
801065a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065a6:	e9 b5 f2 ff ff       	jmp    80105860 <alltraps>
...
801065ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065b2:	e9 a9 f2 ff ff       	jmp    80105860 <alltraps>
...
801065b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065be:	e9 9d f2 ff ff       	jmp    80105860 <alltraps>
...
801065c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065ca:	e9 91 f2 ff ff       	jmp    80105860 <alltraps>
...
801065d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801065d6:	e9 85 f2 ff ff       	jmp    80105860 <alltraps>
...
801065dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065e2:	e9 79 f2 ff ff       	jmp    80105860 <alltraps>
...
801065e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065ee:	e9 6d f2 ff ff       	jmp    80105860 <alltraps>
...
801065f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801065fa:	e9 61 f2 ff ff       	jmp    80105860 <alltraps>
...
80106601:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106606:	e9 55 f2 ff ff       	jmp    80105860 <alltraps>
...
8010660d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106612:	e9 49 f2 ff ff       	jmp    80105860 <alltraps>
...
80106619:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010661e:	e9 3d f2 ff ff       	jmp    80105860 <alltraps>
...
80106625:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010662a:	e9 31 f2 ff ff       	jmp    80105860 <alltraps>
...
80106631:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106636:	e9 25 f2 ff ff       	jmp    80105860 <alltraps>
...
8010663d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106642:	e9 19 f2 ff ff       	jmp    80105860 <alltraps>
...
80106649:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010664e:	e9 0d f2 ff ff       	jmp    80105860 <alltraps>
...
80106655:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010665a:	e9 01 f2 ff ff       	jmp    80105860 <alltraps>
...
80106661:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106666:	e9 f5 f1 ff ff       	jmp    80105860 <alltraps>
...
8010666d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106672:	e9 e9 f1 ff ff       	jmp    80105860 <alltraps>
...
80106679:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010667e:	e9 dd f1 ff ff       	jmp    80105860 <alltraps>
...
80106685:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010668a:	e9 d1 f1 ff ff       	jmp    80105860 <alltraps>
...
80106691:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106696:	e9 c5 f1 ff ff       	jmp    80105860 <alltraps>
...
8010669d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066a2:	e9 b9 f1 ff ff       	jmp    80105860 <alltraps>
...
801066a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066ae:	e9 ad f1 ff ff       	jmp    80105860 <alltraps>
...
801066b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066ba:	e9 a1 f1 ff ff       	jmp    80105860 <alltraps>
...
801066c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066c6:	e9 95 f1 ff ff       	jmp    80105860 <alltraps>
...
801066cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801066d2:	e9 89 f1 ff ff       	jmp    80105860 <alltraps>
...
801066d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066de:	e9 7d f1 ff ff       	jmp    80105860 <alltraps>
...
801066e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066ea:	e9 71 f1 ff ff       	jmp    80105860 <alltraps>
...
801066f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801066f6:	e9 65 f1 ff ff       	jmp    80105860 <alltraps>
...
801066fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106702:	e9 59 f1 ff ff       	jmp    80105860 <alltraps>
...
80106709:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010670e:	e9 4d f1 ff ff       	jmp    80105860 <alltraps>
...
80106715:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010671a:	e9 41 f1 ff ff       	jmp    80105860 <alltraps>
...
80106721:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106726:	e9 35 f1 ff ff       	jmp    80105860 <alltraps>
...
8010672d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106732:	e9 29 f1 ff ff       	jmp    80105860 <alltraps>
...
80106739:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010673e:	e9 1d f1 ff ff       	jmp    80105860 <alltraps>
...
80106745:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010674a:	e9 11 f1 ff ff       	jmp    80105860 <alltraps>
...
80106751:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106756:	e9 05 f1 ff ff       	jmp    80105860 <alltraps>
...
8010675d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106762:	e9 f9 f0 ff ff       	jmp    80105860 <alltraps>
...
80106769:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010676e:	e9 ed f0 ff ff       	jmp    80105860 <alltraps>
...
80106775:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010677a:	e9 e1 f0 ff ff       	jmp    80105860 <alltraps>
...
80106781:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106786:	e9 d5 f0 ff ff       	jmp    80105860 <alltraps>
...
8010678d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106792:	e9 c9 f0 ff ff       	jmp    80105860 <alltraps>
...
80106799:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010679e:	e9 bd f0 ff ff       	jmp    80105860 <alltraps>
...
801067a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067aa:	e9 b1 f0 ff ff       	jmp    80105860 <alltraps>
...
801067b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067b6:	e9 a5 f0 ff ff       	jmp    80105860 <alltraps>
...
801067bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067c2:	e9 99 f0 ff ff       	jmp    80105860 <alltraps>
...
801067e5:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801067e8:	39 d3                	cmp    %edx,%ebx
801067ea:	73 49                	jae    80106835 <deallocuvm.part.0+0x65>
801067ec:	89 c7                	mov    %eax,%edi
801067ee:	eb 0c                	jmp    801067fc <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801067f0:	83 c0 01             	add    $0x1,%eax
801067f3:	c1 e0 16             	shl    $0x16,%eax
801067f6:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
801067f8:	39 da                	cmp    %ebx,%edx
801067fa:	76 39                	jbe    80106835 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
801067fc:	89 d8                	mov    %ebx,%eax
801067fe:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106801:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106804:	f6 c1 01             	test   $0x1,%cl
80106807:	74 e7                	je     801067f0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106809:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010680b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106811:	c1 ee 0a             	shr    $0xa,%esi
80106814:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010681a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106821:	85 f6                	test   %esi,%esi
80106823:	74 cb                	je     801067f0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106825:	8b 06                	mov    (%esi),%eax
80106827:	a8 01                	test   $0x1,%al
80106829:	75 15                	jne    80106840 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
8010682b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106831:	39 da                	cmp    %ebx,%edx
80106833:	77 c7                	ja     801067fc <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106835:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106838:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010683b:	5b                   	pop    %ebx
8010683c:	5e                   	pop    %esi
8010683d:	5f                   	pop    %edi
8010683e:	5d                   	pop    %ebp
...
80106845:	74 25                	je     8010686c <deallocuvm.part.0+0x9c>
      kfree(v);
80106847:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010684a:	05 00 00 00 80       	add    $0x80000000,%eax
8010684f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106852:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106858:	50                   	push   %eax
80106859:	e8 62 bc ff ff       	call   801024c0 <kfree>
      *pte = 0;
8010685e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106864:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106867:	83 c4 10             	add    $0x10,%esp
8010686a:	eb 8c                	jmp    801067f8 <deallocuvm.part.0+0x28>
        panic("kfree");
8010686c:	83 ec 0c             	sub    $0xc,%esp
8010686f:	68 26 74 10 80       	push   $0x80107426
...
801068a5:	89 45 e0             	mov    %eax,-0x20(%ebp)
801068a8:	eb 3d                	jmp    801068e7 <mappages+0x67>
...
801068da:	89 30                	mov    %esi,(%eax)
    if(a == last)
801068dc:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
801068df:	74 6f                	je     80106950 <mappages+0xd0>
    a += PGSIZE;
801068e1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
801068e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
801068ea:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801068ed:	8d 34 18             	lea    (%eax,%ebx,1),%esi
801068f0:	89 d8                	mov    %ebx,%eax
801068f2:	c1 e8 16             	shr    $0x16,%eax
801068f5:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
801068f8:	8b 07                	mov    (%edi),%eax
801068fa:	a8 01                	test   $0x1,%al
801068fc:	75 b2                	jne    801068b0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801068fe:	e8 7d bd ff ff       	call   80102680 <kalloc>
80106903:	85 c0                	test   %eax,%eax
80106905:	74 39                	je     80106940 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106907:	83 ec 04             	sub    $0x4,%esp
8010690a:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010690d:	68 00 10 00 00       	push   $0x1000
80106912:	6a 00                	push   $0x0
80106914:	50                   	push   %eax
80106915:	e8 46 dd ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010691a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010691d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106920:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106926:	83 c8 07             	or     $0x7,%eax
80106929:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010692b:	89 d8                	mov    %ebx,%eax
8010692d:	c1 e8 0a             	shr    $0xa,%eax
80106930:	25 fc 0f 00 00       	and    $0xffc,%eax
80106935:	01 d0                	add    %edx,%eax
80106937:	eb 92                	jmp    801068cb <mappages+0x4b>
...
8010695d:	68 6c 7a 10 80       	push   $0x80107a6c
...
80106973:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106976:	e8 d5 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106a3f:	e8 ac ce ff ff       	call   801038f0 <mycpu>
80106a44:	89 c3                	mov    %eax,%ebx
80106a46:	e8 a5 ce ff ff       	call   801038f0 <mycpu>
80106a4b:	89 c7                	mov    %eax,%edi
80106a4d:	e8 9e ce ff ff       	call   801038f0 <mycpu>
80106a52:	83 c7 08             	add    $0x8,%edi
80106a55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a58:	e8 93 ce ff ff       	call   801038f0 <mycpu>
...
80106aa1:	e8 4a ce ff ff       	call   801038f0 <mycpu>
...
80106ac4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ac7:	e8 24 ce ff ff       	call   801038f0 <mycpu>
...
80106b3b:	77 4b                	ja     80106b88 <inituvm+0x68>
  mem = kalloc();
80106b3d:	e8 3e bb ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b4f:	e8 0c db ff ff       	call   80104660 <memset>
...
80106b68:	e8 13 fd ff ff       	call   80106880 <mappages>
  memmove(mem, init, sz);
...
80106b82:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b83:	e9 78 db ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106b88:	83 ec 0c             	sub    $0xc,%esp
80106b8b:	68 b1 7a 10 80       	push   $0x80107ab1
...
80106bb4:	0f 85 bb 00 00 00    	jne    80106c75 <loaduvm+0xd5>
...
80106bcb:	0f 84 87 00 00 00    	je     80106c58 <loaduvm+0xb8>
80106bd1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106bd8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106bdb:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106bde:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106be0:	89 c2                	mov    %eax,%edx
80106be2:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106be5:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106be8:	f6 c2 01             	test   $0x1,%dl
80106beb:	75 13                	jne    80106c00 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106bed:	83 ec 0c             	sub    $0xc,%esp
80106bf0:	68 cb 7a 10 80       	push   $0x80107acb
80106bf5:	e8 86 97 ff ff       	call   80100380 <panic>
80106bfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106c00:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c03:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106c09:	25 fc 0f 00 00       	and    $0xffc,%eax
80106c0e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106c15:	85 c0                	test   %eax,%eax
80106c17:	74 d4                	je     80106bed <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
80106c3b:	ff 75 10             	push   0x10(%ebp)
80106c3e:	e8 4d ae ff ff       	call   80101a90 <readi>
80106c43:	83 c4 10             	add    $0x10,%esp
80106c46:	39 f8                	cmp    %edi,%eax
80106c48:	75 1e                	jne    80106c68 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106c4a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c50:	89 f0                	mov    %esi,%eax
80106c52:	29 d8                	sub    %ebx,%eax
80106c54:	39 c6                	cmp    %eax,%esi
80106c56:	77 80                	ja     80106bd8 <loaduvm+0x38>
}
...
80106c78:	68 6c 7b 10 80       	push   $0x80107b6c
...
80106cf4:	e8 87 fb ff ff       	call   80106880 <mappages>
...
80106d09:	76 48                	jbe    80106d53 <allocuvm+0xc3>
    mem = kalloc();
80106d0b:	e8 70 b9 ff ff       	call   80102680 <kalloc>
...
80106d19:	68 e9 7a 10 80       	push   $0x80107ae9
...
80106d35:	e8 96 fa ff ff       	call   801067d0 <deallocuvm.part.0>
      return 0;
...
80106d7b:	68 01 7b 10 80       	push   $0x80107b01
...
80106d97:	e8 34 fa ff ff       	call   801067d0 <deallocuvm.part.0>
      kfree(mem);
80106d9c:	83 ec 0c             	sub    $0xc,%esp
80106d9f:	53                   	push   %ebx
80106da0:	e8 1b b7 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106dd0:	5d                   	pop    %ebp
80106dd1:	e9 fa f9 ff ff       	jmp    801067d0 <deallocuvm.part.0>
...
80106e0b:	e8 c0 f9 ff ff       	call   801067d0 <deallocuvm.part.0>
...
80106e3e:	e8 7d b6 ff ff       	call   801024c0 <kfree>
...
80106e53:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e54:	e9 67 b6 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106e59:	83 ec 0c             	sub    $0xc,%esp
80106e5c:	68 1d 7b 10 80       	push   $0x80107b1d
...
80106e75:	e8 06 b8 ff ff       	call   80102680 <kalloc>
...
80106f2c:	68 2e 7b 10 80       	push   $0x80107b2e
...
80106f73:	0f 84 bd 00 00 00    	je     80107036 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106fa2:	68 38 7b 10 80       	push   $0x80107b38
...
80107000:	e8 fb d6 ff ff       	call   80104700 <memmove>
...
8010701b:	e8 60 f8 ff ff       	call   80106880 <mappages>
...
80107030:	0f 87 5a ff ff ff    	ja     80106f90 <copyuvm+0x30>
  return d;
...
8010704c:	e8 6f b4 ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010705a:	e8 91 fd ff ff       	call   80106df0 <freevm>
  return 0;
8010705f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107077:	68 52 7b 10 80       	push   $0x80107b52
...
801070a4:	0f 84 00 01 00 00    	je     801071aa <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801070b4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801070b9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
801070cf:	83 fa 05             	cmp    $0x5,%edx
801070d2:	ba 00 00 00 00       	mov    $0x0,%edx
801070d7:	0f 45 c2             	cmovne %edx,%eax
}
801070da:	c3                   	ret    
...
801070f6:	e9 a5 00 00 00       	jmp    801071a0 <copyout+0xc0>
...
80107112:	74 75                	je     80107189 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
80107116:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107119:	29 c3                	sub    %eax,%ebx
8010711b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107121:	39 f3                	cmp    %esi,%ebx
80107123:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107126:	29 f8                	sub    %edi,%eax
80107128:	83 ec 04             	sub    $0x4,%esp
8010712b:	01 c1                	add    %eax,%ecx
8010712d:	53                   	push   %ebx
8010712e:	52                   	push   %edx
8010712f:	51                   	push   %ecx
80107130:	e8 cb d5 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
...
80107145:	74 59                	je     801071a0 <copyout+0xc0>
  if(*pde & PTE_P){
...
8010715d:	0f 84 4e 00 00 00    	je     801071b1 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010717d:	83 e1 05             	and    $0x5,%ecx
80107180:	83 f9 05             	cmp    $0x5,%ecx
80107183:	0f 84 77 ff ff ff    	je     80107100 <copyout+0x20>
  }
  return 0;
}
80107189:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
8010718c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107191:	5b                   	pop    %ebx
80107192:	5e                   	pop    %esi
80107193:	5f                   	pop    %edi
...
801071aa <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801071aa:	a1 00 00 00 00       	mov    0x0,%eax
801071af:	0f 0b                	ud2    

801071b1 <copyout.cold>:
801071b1:	a1 00 00 00 00       	mov    0x0,%eax
801071b6:	0f 0b                	ud2    
