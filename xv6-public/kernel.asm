...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 9f 7b 10 80 	movl   $0x80107b9f,(%esp)
...
80102088:	68 86 79 10 80       	push   $0x80107986
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 25 3a 00 00       	call   80106a70 <switchkvm>
  seginit();
8010304b:	e8 90 39 00 00       	call   801069e0 <seginit>
  lapicinit();
...
80103081:	e8 da 3e 00 00       	call   80106f60 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 4b 39 00 00       	call   801069e0 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 c7 2b 00 00       	call   80105c70 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 4d 28 00 00       	call   80105900 <tvinit>
  binit();         // buffer cache
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 e7 58 10 80 	movl   $0x801058e7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103945:	68 64 78 10 80       	push   $0x80107864
...
801039d1:	e8 ba 31 00 00       	call   80106b90 <inituvm>
...
80103abb:	e8 c0 2f 00 00       	call   80106a80 <switchuvm>
  return 0;
...
80103f89:	e8 d2 2e 00 00       	call   80106e60 <freevm>
        p->pid = 0;
...
801041fb:	68 9f 7b 10 80       	push   $0x80107b9f
...
80104228:	8b 14 85 8c 78 10 80 	mov    -0x7fef8774(,%eax,4),%edx
      state = "???";
...
801042aa:	68 a4 78 10 80       	push   $0x801078a4
...
801044e5:	68 af 78 10 80       	push   $0x801078af
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 c6 78 10 80       	push   $0x801078c6
...
8010455b:	68 cd 78 10 80       	push   $0x801078cd
...
80104650:	68 d5 78 10 80       	push   $0x801078d5
...
80104a7c:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
80104aa8:	68 dd 78 10 80       	push   $0x801078dd
...
80104c04:	68 7c 79 10 80       	push   $0x8010797c
...
80104c1c:	68 7b 79 10 80       	push   $0x8010797b
...
80104c31:	68 6f 79 10 80       	push   $0x8010796f
...
80104c4f:	68 7e 79 10 80       	push   $0x8010797e
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 60 79 10 80       	push   $0x80107960
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 7c 79 10 80       	push   $0x8010797c
...
80105078:	68 7b 79 10 80       	push   $0x8010797b
...
80105870:	74 51                	je     801058c3 <sys_num_pages+0x63>
    }
...
80105872:	8b 70 04             	mov    0x4(%eax),%esi
    int count = 0;
80105875:	31 c9                	xor    %ecx,%ecx
80105877:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
8010587d:	eb 08                	jmp    80105887 <sys_num_pages+0x27>
8010587f:	90                   	nop
    for (int i = 0; i < NPDENTRIES; i++) {
80105880:	83 c6 04             	add    $0x4,%esi
80105883:	39 fe                	cmp    %edi,%esi
80105885:	74 32                	je     801058b9 <sys_num_pages+0x59>
        if (pgdir[i] & PTE_P) { 
80105887:	8b 1e                	mov    (%esi),%ebx
80105889:	f6 c3 01             	test   $0x1,%bl
8010588c:	74 f2                	je     80105880 <sys_num_pages+0x20>
            pte_t *pte = (pte_t *)P2V(PTE_ADDR(pgdir[i])); 
8010588e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105894:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
            for (int j = 0; j < NPTENTRIES; j++) {
8010589a:	81 eb 00 f0 ff 7f    	sub    $0x7ffff000,%ebx
                if (pte[j] & PTE_P) { 
801058a0:	8b 10                	mov    (%eax),%edx
801058a2:	83 e2 01             	and    $0x1,%edx
                    count++; 
801058a5:	83 fa 01             	cmp    $0x1,%edx
801058a8:	83 d9 ff             	sbb    $0xffffffff,%ecx
            for (int j = 0; j < NPTENTRIES; j++) {
801058ab:	83 c0 04             	add    $0x4,%eax
801058ae:	39 c3                	cmp    %eax,%ebx
801058b0:	75 ee                	jne    801058a0 <sys_num_pages+0x40>
    for (int i = 0; i < NPDENTRIES; i++) {
801058b2:	83 c6 04             	add    $0x4,%esi
801058b5:	39 fe                	cmp    %edi,%esi
801058b7:	75 ce                	jne    80105887 <sys_num_pages+0x27>
            }
        }
    }
...
801058b9:	83 c4 0c             	add    $0xc,%esp
801058bc:	89 c8                	mov    %ecx,%eax
801058be:	5b                   	pop    %ebx
801058bf:	5e                   	pop    %esi
801058c0:	5f                   	pop    %edi
801058c1:	5d                   	pop    %ebp
801058c2:	c3                   	ret    
801058c3:	83 c4 0c             	add    $0xc,%esp
        return 0; 
801058c6:	31 c9                	xor    %ecx,%ecx
}
801058c8:	5b                   	pop    %ebx
801058c9:	89 c8                	mov    %ecx,%eax
801058cb:	5e                   	pop    %esi
801058cc:	5f                   	pop    %edi
801058cd:	5d                   	pop    %ebp
801058ce:	c3                   	ret    
...
80105917:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
8010591e:	08 00 00 8e 
80105922:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
80105929:	80 
8010592a:	c1 ea 10             	shr    $0x10,%edx
8010592d:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
80105934:	80 
  for(i = 0; i < 256; i++)
...
80105947:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
8010594e:	00 00 ef 
  initlock(&tickslock, "time");
80105951:	68 c1 79 10 80       	push   $0x801079c1
80105956:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010595b:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105961:	c1 e8 10             	shr    $0x10,%eax
80105964:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
...
8010598b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010598f:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
801059c2:	0f 84 68 01 00 00    	je     80105b30 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059ce:	0f 87 8c 00 00 00    	ja     80105a60 <trap+0xb0>
801059d4:	ff 24 85 68 7a 10 80 	jmp    *-0x7fef8598(,%eax,4)
...
801059df:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059e0:	e8 5b c8 ff ff       	call   80102240 <ideintr>
    lapiceoi();
801059e5:	e8 26 cf ff ff       	call   80102910 <lapiceoi>
  }
...
801059ea:	e8 81 df ff ff       	call   80103970 <myproc>
801059ef:	85 c0                	test   %eax,%eax
801059f1:	74 1d                	je     80105a10 <trap+0x60>
801059f3:	e8 78 df ff ff       	call   80103970 <myproc>
801059f8:	8b 50 24             	mov    0x24(%eax),%edx
801059fb:	85 d2                	test   %edx,%edx
801059fd:	74 11                	je     80105a10 <trap+0x60>
801059ff:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a03:	83 e0 03             	and    $0x3,%eax
80105a06:	66 83 f8 03          	cmp    $0x3,%ax
80105a0a:	0f 84 e8 01 00 00    	je     80105bf8 <trap+0x248>
    exit();
...
80105a65:	8b 7b 38             	mov    0x38(%ebx),%edi
80105a68:	85 c0                	test   %eax,%eax
80105a6a:	0f 84 a2 01 00 00    	je     80105c12 <trap+0x262>
80105a70:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a74:	0f 84 98 01 00 00    	je     80105c12 <trap+0x262>
...
80105a80:	e8 cb de ff ff       	call   80103950 <cpuid>
80105a85:	8b 73 30             	mov    0x30(%ebx),%esi
80105a88:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105a8b:	8b 43 34             	mov    0x34(%ebx),%eax
...
80105aa7:	ff 75 e4             	push   -0x1c(%ebp)
80105aaa:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105aab:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105aae:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ab1:	56                   	push   %esi
80105ab2:	ff 70 10             	push   0x10(%eax)
80105ab5:	68 24 7a 10 80       	push   $0x80107a24
80105aba:	e8 e1 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
...
80105ac7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ace:	e8 9d de ff ff       	call   80103970 <myproc>
80105ad3:	85 c0                	test   %eax,%eax
80105ad5:	0f 85 18 ff ff ff    	jne    801059f3 <trap+0x43>
80105adb:	e9 30 ff ff ff       	jmp    80105a10 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105ae0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ae4:	0f 85 3e ff ff ff    	jne    80105a28 <trap+0x78>
    yield();
80105aea:	e8 01 e5 ff ff       	call   80103ff0 <yield>
80105aef:	e9 34 ff ff ff       	jmp    80105a28 <trap+0x78>
80105af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105af8:	8b 7b 38             	mov    0x38(%ebx),%edi
80105afb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105aff:	e8 4c de ff ff       	call   80103950 <cpuid>
80105b04:	57                   	push   %edi
80105b05:	56                   	push   %esi
80105b06:	50                   	push   %eax
80105b07:	68 cc 79 10 80       	push   $0x801079cc
80105b0c:	e8 8f ab ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105b11:	e8 fa cd ff ff       	call   80102910 <lapiceoi>
    break;
80105b16:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b19:	e8 52 de ff ff       	call   80103970 <myproc>
80105b1e:	85 c0                	test   %eax,%eax
80105b20:	0f 85 cd fe ff ff    	jne    801059f3 <trap+0x43>
80105b26:	e9 e5 fe ff ff       	jmp    80105a10 <trap+0x60>
80105b2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b2f:	90                   	nop
    if(myproc()->killed)
80105b30:	e8 3b de ff ff       	call   80103970 <myproc>
80105b35:	8b 70 24             	mov    0x24(%eax),%esi
80105b38:	85 f6                	test   %esi,%esi
80105b3a:	0f 85 c8 00 00 00    	jne    80105c08 <trap+0x258>
    myproc()->tf = tf;
80105b40:	e8 2b de ff ff       	call   80103970 <myproc>
80105b45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b48:	e8 13 ef ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105b4d:	e8 1e de ff ff       	call   80103970 <myproc>
80105b52:	8b 48 24             	mov    0x24(%eax),%ecx
80105b55:	85 c9                	test   %ecx,%ecx
80105b57:	0f 84 f1 fe ff ff    	je     80105a4e <trap+0x9e>
}
...
80105b63:	5d                   	pop    %ebp
      exit();
80105b64:	e9 27 e2 ff ff       	jmp    80103d90 <exit>
80105b69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b70:	e8 3b 02 00 00       	call   80105db0 <uartintr>
    lapiceoi();
80105b75:	e8 96 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b7a:	e8 f1 dd ff ff       	call   80103970 <myproc>
80105b7f:	85 c0                	test   %eax,%eax
80105b81:	0f 85 6c fe ff ff    	jne    801059f3 <trap+0x43>
80105b87:	e9 84 fe ff ff       	jmp    80105a10 <trap+0x60>
80105b8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b90:	e8 3b cc ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105b95:	e8 76 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b9a:	e8 d1 dd ff ff       	call   80103970 <myproc>
80105b9f:	85 c0                	test   %eax,%eax
80105ba1:	0f 85 4c fe ff ff    	jne    801059f3 <trap+0x43>
80105ba7:	e9 64 fe ff ff       	jmp    80105a10 <trap+0x60>
80105bac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105bb0:	e8 9b dd ff ff       	call   80103950 <cpuid>
80105bb5:	85 c0                	test   %eax,%eax
80105bb7:	0f 85 28 fe ff ff    	jne    801059e5 <trap+0x35>
      acquire(&tickslock);
80105bbd:	83 ec 0c             	sub    $0xc,%esp
80105bc0:	68 80 3c 11 80       	push   $0x80113c80
80105bc5:	e8 d6 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105bca:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105bd1:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105bd8:	e8 23 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105bdd:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105be4:	e8 57 e9 ff ff       	call   80104540 <release>
80105be9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105bec:	e9 f4 fd ff ff       	jmp    801059e5 <trap+0x35>
80105bf1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105bf8:	e8 93 e1 ff ff       	call   80103d90 <exit>
80105bfd:	e9 0e fe ff ff       	jmp    80105a10 <trap+0x60>
80105c02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c08:	e8 83 e1 ff ff       	call   80103d90 <exit>
80105c0d:	e9 2e ff ff ff       	jmp    80105b40 <trap+0x190>
80105c12:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c15:	e8 36 dd ff ff       	call   80103950 <cpuid>
80105c1a:	83 ec 0c             	sub    $0xc,%esp
80105c1d:	56                   	push   %esi
80105c1e:	57                   	push   %edi
80105c1f:	50                   	push   %eax
80105c20:	ff 73 30             	push   0x30(%ebx)
80105c23:	68 f0 79 10 80       	push   $0x801079f0
80105c28:	e8 73 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c2d:	83 c4 14             	add    $0x14,%esp
80105c30:	68 c6 79 10 80       	push   $0x801079c6
80105c35:	e8 46 a7 ff ff       	call   80100380 <panic>
...
80105cdc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cdf:	bf e8 7a 10 80       	mov    $0x80107ae8,%edi
80105ce4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105ce9:	6a 00                	push   $0x0
80105ceb:	6a 04                	push   $0x4
80105ced:	e8 8e c7 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105dc7:	6a 00                	push   $0x0
  jmp alltraps
80105dc9:	e9 01 fb ff ff       	jmp    801058cf <alltraps>
...
80105dd0:	6a 01                	push   $0x1
  jmp alltraps
80105dd2:	e9 f8 fa ff ff       	jmp    801058cf <alltraps>
...
80105dd9:	6a 02                	push   $0x2
  jmp alltraps
80105ddb:	e9 ef fa ff ff       	jmp    801058cf <alltraps>
...
80105de2:	6a 03                	push   $0x3
  jmp alltraps
80105de4:	e9 e6 fa ff ff       	jmp    801058cf <alltraps>
...
80105deb:	6a 04                	push   $0x4
  jmp alltraps
80105ded:	e9 dd fa ff ff       	jmp    801058cf <alltraps>
...
80105df4:	6a 05                	push   $0x5
  jmp alltraps
80105df6:	e9 d4 fa ff ff       	jmp    801058cf <alltraps>
...
80105e0d:	6a 08                	push   $0x8
  jmp alltraps
80105e0f:	e9 bb fa ff ff       	jmp    801058cf <alltraps>
...
80105e1d:	6a 0a                	push   $0xa
  jmp alltraps
80105e1f:	e9 ab fa ff ff       	jmp    801058cf <alltraps>
...
80105e24:	6a 0b                	push   $0xb
  jmp alltraps
80105e26:	e9 a4 fa ff ff       	jmp    801058cf <alltraps>
...
80105e2b:	6a 0c                	push   $0xc
  jmp alltraps
80105e2d:	e9 9d fa ff ff       	jmp    801058cf <alltraps>
...
80105e32:	6a 0d                	push   $0xd
  jmp alltraps
80105e34:	e9 96 fa ff ff       	jmp    801058cf <alltraps>
...
80105e39:	6a 0e                	push   $0xe
  jmp alltraps
80105e3b:	e9 8f fa ff ff       	jmp    801058cf <alltraps>
...
80105e42:	6a 0f                	push   $0xf
  jmp alltraps
80105e44:	e9 86 fa ff ff       	jmp    801058cf <alltraps>
...
80105e4b:	6a 10                	push   $0x10
  jmp alltraps
80105e4d:	e9 7d fa ff ff       	jmp    801058cf <alltraps>
...
80105e52:	6a 11                	push   $0x11
  jmp alltraps
80105e54:	e9 76 fa ff ff       	jmp    801058cf <alltraps>
...
80105e5b:	6a 12                	push   $0x12
  jmp alltraps
80105e5d:	e9 6d fa ff ff       	jmp    801058cf <alltraps>
...
80105e64:	6a 13                	push   $0x13
  jmp alltraps
80105e66:	e9 64 fa ff ff       	jmp    801058cf <alltraps>
...
80105e6d:	6a 14                	push   $0x14
  jmp alltraps
80105e6f:	e9 5b fa ff ff       	jmp    801058cf <alltraps>
...
80105e76:	6a 15                	push   $0x15
  jmp alltraps
80105e78:	e9 52 fa ff ff       	jmp    801058cf <alltraps>
...
80105e7f:	6a 16                	push   $0x16
  jmp alltraps
80105e81:	e9 49 fa ff ff       	jmp    801058cf <alltraps>
...
80105e88:	6a 17                	push   $0x17
  jmp alltraps
80105e8a:	e9 40 fa ff ff       	jmp    801058cf <alltraps>
...
80105e91:	6a 18                	push   $0x18
  jmp alltraps
80105e93:	e9 37 fa ff ff       	jmp    801058cf <alltraps>
...
80105e9a:	6a 19                	push   $0x19
  jmp alltraps
80105e9c:	e9 2e fa ff ff       	jmp    801058cf <alltraps>
...
80105ea3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ea5:	e9 25 fa ff ff       	jmp    801058cf <alltraps>
...
80105eac:	6a 1b                	push   $0x1b
  jmp alltraps
80105eae:	e9 1c fa ff ff       	jmp    801058cf <alltraps>
...
80105eb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105eb7:	e9 13 fa ff ff       	jmp    801058cf <alltraps>
...
80105ebe:	6a 1d                	push   $0x1d
  jmp alltraps
80105ec0:	e9 0a fa ff ff       	jmp    801058cf <alltraps>
...
80105ec7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ec9:	e9 01 fa ff ff       	jmp    801058cf <alltraps>
...
80105ed0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ed2:	e9 f8 f9 ff ff       	jmp    801058cf <alltraps>
...
80105ed9:	6a 20                	push   $0x20
  jmp alltraps
80105edb:	e9 ef f9 ff ff       	jmp    801058cf <alltraps>
...
80105ee2:	6a 21                	push   $0x21
  jmp alltraps
80105ee4:	e9 e6 f9 ff ff       	jmp    801058cf <alltraps>
...
80105eeb:	6a 22                	push   $0x22
  jmp alltraps
80105eed:	e9 dd f9 ff ff       	jmp    801058cf <alltraps>
...
80105ef4:	6a 23                	push   $0x23
  jmp alltraps
80105ef6:	e9 d4 f9 ff ff       	jmp    801058cf <alltraps>
...
80105efd:	6a 24                	push   $0x24
  jmp alltraps
80105eff:	e9 cb f9 ff ff       	jmp    801058cf <alltraps>
...
80105f06:	6a 25                	push   $0x25
  jmp alltraps
80105f08:	e9 c2 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f0f:	6a 26                	push   $0x26
  jmp alltraps
80105f11:	e9 b9 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f18:	6a 27                	push   $0x27
  jmp alltraps
80105f1a:	e9 b0 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f21:	6a 28                	push   $0x28
  jmp alltraps
80105f23:	e9 a7 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f2a:	6a 29                	push   $0x29
  jmp alltraps
80105f2c:	e9 9e f9 ff ff       	jmp    801058cf <alltraps>
...
80105f33:	6a 2a                	push   $0x2a
  jmp alltraps
80105f35:	e9 95 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f3e:	e9 8c f9 ff ff       	jmp    801058cf <alltraps>
...
80105f45:	6a 2c                	push   $0x2c
  jmp alltraps
80105f47:	e9 83 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f50:	e9 7a f9 ff ff       	jmp    801058cf <alltraps>
...
80105f57:	6a 2e                	push   $0x2e
  jmp alltraps
80105f59:	e9 71 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f60:	6a 2f                	push   $0x2f
  jmp alltraps
80105f62:	e9 68 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f69:	6a 30                	push   $0x30
  jmp alltraps
80105f6b:	e9 5f f9 ff ff       	jmp    801058cf <alltraps>
...
80105f72:	6a 31                	push   $0x31
  jmp alltraps
80105f74:	e9 56 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f7b:	6a 32                	push   $0x32
  jmp alltraps
80105f7d:	e9 4d f9 ff ff       	jmp    801058cf <alltraps>
...
80105f84:	6a 33                	push   $0x33
  jmp alltraps
80105f86:	e9 44 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f8d:	6a 34                	push   $0x34
  jmp alltraps
80105f8f:	e9 3b f9 ff ff       	jmp    801058cf <alltraps>
...
80105f96:	6a 35                	push   $0x35
  jmp alltraps
80105f98:	e9 32 f9 ff ff       	jmp    801058cf <alltraps>
...
80105f9f:	6a 36                	push   $0x36
  jmp alltraps
80105fa1:	e9 29 f9 ff ff       	jmp    801058cf <alltraps>
...
80105fa8:	6a 37                	push   $0x37
  jmp alltraps
80105faa:	e9 20 f9 ff ff       	jmp    801058cf <alltraps>
...
80105fb1:	6a 38                	push   $0x38
  jmp alltraps
80105fb3:	e9 17 f9 ff ff       	jmp    801058cf <alltraps>
...
80105fba:	6a 39                	push   $0x39
  jmp alltraps
80105fbc:	e9 0e f9 ff ff       	jmp    801058cf <alltraps>
...
80105fc3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fc5:	e9 05 f9 ff ff       	jmp    801058cf <alltraps>
...
80105fcc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fce:	e9 fc f8 ff ff       	jmp    801058cf <alltraps>
...
80105fd5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fd7:	e9 f3 f8 ff ff       	jmp    801058cf <alltraps>
...
80105fde:	6a 3d                	push   $0x3d
  jmp alltraps
80105fe0:	e9 ea f8 ff ff       	jmp    801058cf <alltraps>
...
80105fe7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fe9:	e9 e1 f8 ff ff       	jmp    801058cf <alltraps>
...
80105ff0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ff2:	e9 d8 f8 ff ff       	jmp    801058cf <alltraps>
...
80105ff9:	6a 40                	push   $0x40
  jmp alltraps
80105ffb:	e9 cf f8 ff ff       	jmp    801058cf <alltraps>
...
80106002:	6a 41                	push   $0x41
  jmp alltraps
80106004:	e9 c6 f8 ff ff       	jmp    801058cf <alltraps>
...
8010600b:	6a 42                	push   $0x42
  jmp alltraps
8010600d:	e9 bd f8 ff ff       	jmp    801058cf <alltraps>
...
80106014:	6a 43                	push   $0x43
  jmp alltraps
80106016:	e9 b4 f8 ff ff       	jmp    801058cf <alltraps>
...
8010601d:	6a 44                	push   $0x44
  jmp alltraps
8010601f:	e9 ab f8 ff ff       	jmp    801058cf <alltraps>
...
80106026:	6a 45                	push   $0x45
  jmp alltraps
80106028:	e9 a2 f8 ff ff       	jmp    801058cf <alltraps>
...
8010602f:	6a 46                	push   $0x46
  jmp alltraps
80106031:	e9 99 f8 ff ff       	jmp    801058cf <alltraps>
...
80106038:	6a 47                	push   $0x47
  jmp alltraps
8010603a:	e9 90 f8 ff ff       	jmp    801058cf <alltraps>
...
80106041:	6a 48                	push   $0x48
  jmp alltraps
80106043:	e9 87 f8 ff ff       	jmp    801058cf <alltraps>
...
8010604a:	6a 49                	push   $0x49
  jmp alltraps
8010604c:	e9 7e f8 ff ff       	jmp    801058cf <alltraps>
...
80106053:	6a 4a                	push   $0x4a
  jmp alltraps
80106055:	e9 75 f8 ff ff       	jmp    801058cf <alltraps>
...
8010605c:	6a 4b                	push   $0x4b
  jmp alltraps
8010605e:	e9 6c f8 ff ff       	jmp    801058cf <alltraps>
...
80106065:	6a 4c                	push   $0x4c
  jmp alltraps
80106067:	e9 63 f8 ff ff       	jmp    801058cf <alltraps>
...
8010606e:	6a 4d                	push   $0x4d
  jmp alltraps
80106070:	e9 5a f8 ff ff       	jmp    801058cf <alltraps>
...
80106077:	6a 4e                	push   $0x4e
  jmp alltraps
80106079:	e9 51 f8 ff ff       	jmp    801058cf <alltraps>
...
80106080:	6a 4f                	push   $0x4f
  jmp alltraps
80106082:	e9 48 f8 ff ff       	jmp    801058cf <alltraps>
...
80106089:	6a 50                	push   $0x50
  jmp alltraps
8010608b:	e9 3f f8 ff ff       	jmp    801058cf <alltraps>
...
80106092:	6a 51                	push   $0x51
  jmp alltraps
80106094:	e9 36 f8 ff ff       	jmp    801058cf <alltraps>
...
8010609b:	6a 52                	push   $0x52
  jmp alltraps
8010609d:	e9 2d f8 ff ff       	jmp    801058cf <alltraps>
...
801060a4:	6a 53                	push   $0x53
  jmp alltraps
801060a6:	e9 24 f8 ff ff       	jmp    801058cf <alltraps>
...
801060ad:	6a 54                	push   $0x54
  jmp alltraps
801060af:	e9 1b f8 ff ff       	jmp    801058cf <alltraps>
...
801060b6:	6a 55                	push   $0x55
  jmp alltraps
801060b8:	e9 12 f8 ff ff       	jmp    801058cf <alltraps>
...
801060bf:	6a 56                	push   $0x56
  jmp alltraps
801060c1:	e9 09 f8 ff ff       	jmp    801058cf <alltraps>
...
801060c8:	6a 57                	push   $0x57
  jmp alltraps
801060ca:	e9 00 f8 ff ff       	jmp    801058cf <alltraps>
...
801060d1:	6a 58                	push   $0x58
  jmp alltraps
801060d3:	e9 f7 f7 ff ff       	jmp    801058cf <alltraps>
...
801060da:	6a 59                	push   $0x59
  jmp alltraps
801060dc:	e9 ee f7 ff ff       	jmp    801058cf <alltraps>
...
801060e3:	6a 5a                	push   $0x5a
  jmp alltraps
801060e5:	e9 e5 f7 ff ff       	jmp    801058cf <alltraps>
...
801060ec:	6a 5b                	push   $0x5b
  jmp alltraps
801060ee:	e9 dc f7 ff ff       	jmp    801058cf <alltraps>
...
801060f5:	6a 5c                	push   $0x5c
  jmp alltraps
801060f7:	e9 d3 f7 ff ff       	jmp    801058cf <alltraps>
...
801060fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106100:	e9 ca f7 ff ff       	jmp    801058cf <alltraps>
...
80106107:	6a 5e                	push   $0x5e
  jmp alltraps
80106109:	e9 c1 f7 ff ff       	jmp    801058cf <alltraps>
...
80106110:	6a 5f                	push   $0x5f
  jmp alltraps
80106112:	e9 b8 f7 ff ff       	jmp    801058cf <alltraps>
...
80106119:	6a 60                	push   $0x60
  jmp alltraps
8010611b:	e9 af f7 ff ff       	jmp    801058cf <alltraps>
...
80106122:	6a 61                	push   $0x61
  jmp alltraps
80106124:	e9 a6 f7 ff ff       	jmp    801058cf <alltraps>
...
8010612b:	6a 62                	push   $0x62
  jmp alltraps
8010612d:	e9 9d f7 ff ff       	jmp    801058cf <alltraps>
...
80106134:	6a 63                	push   $0x63
  jmp alltraps
80106136:	e9 94 f7 ff ff       	jmp    801058cf <alltraps>
...
8010613d:	6a 64                	push   $0x64
  jmp alltraps
8010613f:	e9 8b f7 ff ff       	jmp    801058cf <alltraps>
...
80106146:	6a 65                	push   $0x65
  jmp alltraps
80106148:	e9 82 f7 ff ff       	jmp    801058cf <alltraps>
...
8010614f:	6a 66                	push   $0x66
  jmp alltraps
80106151:	e9 79 f7 ff ff       	jmp    801058cf <alltraps>
...
80106158:	6a 67                	push   $0x67
  jmp alltraps
8010615a:	e9 70 f7 ff ff       	jmp    801058cf <alltraps>
...
80106161:	6a 68                	push   $0x68
  jmp alltraps
80106163:	e9 67 f7 ff ff       	jmp    801058cf <alltraps>
...
8010616a:	6a 69                	push   $0x69
  jmp alltraps
8010616c:	e9 5e f7 ff ff       	jmp    801058cf <alltraps>
...
80106173:	6a 6a                	push   $0x6a
  jmp alltraps
80106175:	e9 55 f7 ff ff       	jmp    801058cf <alltraps>
...
8010617c:	6a 6b                	push   $0x6b
  jmp alltraps
8010617e:	e9 4c f7 ff ff       	jmp    801058cf <alltraps>
...
80106185:	6a 6c                	push   $0x6c
  jmp alltraps
80106187:	e9 43 f7 ff ff       	jmp    801058cf <alltraps>
...
8010618e:	6a 6d                	push   $0x6d
  jmp alltraps
80106190:	e9 3a f7 ff ff       	jmp    801058cf <alltraps>
...
80106197:	6a 6e                	push   $0x6e
  jmp alltraps
80106199:	e9 31 f7 ff ff       	jmp    801058cf <alltraps>
...
801061a0:	6a 6f                	push   $0x6f
  jmp alltraps
801061a2:	e9 28 f7 ff ff       	jmp    801058cf <alltraps>
...
801061a9:	6a 70                	push   $0x70
  jmp alltraps
801061ab:	e9 1f f7 ff ff       	jmp    801058cf <alltraps>
...
801061b2:	6a 71                	push   $0x71
  jmp alltraps
801061b4:	e9 16 f7 ff ff       	jmp    801058cf <alltraps>
...
801061bb:	6a 72                	push   $0x72
  jmp alltraps
801061bd:	e9 0d f7 ff ff       	jmp    801058cf <alltraps>
...
801061c4:	6a 73                	push   $0x73
  jmp alltraps
801061c6:	e9 04 f7 ff ff       	jmp    801058cf <alltraps>
...
801061cd:	6a 74                	push   $0x74
  jmp alltraps
801061cf:	e9 fb f6 ff ff       	jmp    801058cf <alltraps>
...
801061d6:	6a 75                	push   $0x75
  jmp alltraps
801061d8:	e9 f2 f6 ff ff       	jmp    801058cf <alltraps>
...
801061df:	6a 76                	push   $0x76
  jmp alltraps
801061e1:	e9 e9 f6 ff ff       	jmp    801058cf <alltraps>
...
801061e8:	6a 77                	push   $0x77
  jmp alltraps
801061ea:	e9 e0 f6 ff ff       	jmp    801058cf <alltraps>
...
801061f1:	6a 78                	push   $0x78
  jmp alltraps
801061f3:	e9 d7 f6 ff ff       	jmp    801058cf <alltraps>
...
801061fa:	6a 79                	push   $0x79
  jmp alltraps
801061fc:	e9 ce f6 ff ff       	jmp    801058cf <alltraps>
...
80106203:	6a 7a                	push   $0x7a
  jmp alltraps
80106205:	e9 c5 f6 ff ff       	jmp    801058cf <alltraps>
...
80106215:	6a 7c                	push   $0x7c
  jmp alltraps
80106217:	e9 b3 f6 ff ff       	jmp    801058cf <alltraps>
...
8010621e:	6a 7d                	push   $0x7d
  jmp alltraps
80106220:	e9 aa f6 ff ff       	jmp    801058cf <alltraps>
...
80106227:	6a 7e                	push   $0x7e
  jmp alltraps
80106229:	e9 a1 f6 ff ff       	jmp    801058cf <alltraps>
...
801067fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106802:	e9 c8 f0 ff ff       	jmp    801058cf <alltraps>
...
80106809:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010680e:	e9 bc f0 ff ff       	jmp    801058cf <alltraps>
...
80106815:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010681a:	e9 b0 f0 ff ff       	jmp    801058cf <alltraps>
...
80106821:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106826:	e9 a4 f0 ff ff       	jmp    801058cf <alltraps>
...
8010682d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106832:	e9 98 f0 ff ff       	jmp    801058cf <alltraps>
...
801068c9:	e8 f2 bb ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
8010696e:	e8 0d bd ff ff       	call   80102680 <kalloc>
...
80106985:	e8 d6 dc ff ff       	call   80104660 <memset>
...
801069cd:	68 f0 7a 10 80       	push   $0x80107af0
...
801069e3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069e6:	e8 65 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106ab6:	e8 35 ce ff ff       	call   801038f0 <mycpu>
...
80106ac8:	e8 23 ce ff ff       	call   801038f0 <mycpu>
...
80106b11:	e8 da cd ff ff       	call   801038f0 <mycpu>
80106b16:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b1d:	e8 ce cd ff ff       	call   801038f0 <mycpu>
...
80106b34:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b37:	e8 b4 cd ff ff       	call   801038f0 <mycpu>
...
80106bab:	77 4b                	ja     80106bf8 <inituvm+0x68>
  mem = kalloc();
80106bad:	e8 ce ba ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bbf:	e8 9c da ff ff       	call   80104660 <memset>
...
80106bd8:	e8 13 fd ff ff       	call   801068f0 <mappages>
  memmove(mem, init, sz);
80106bdd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106be0:	89 75 10             	mov    %esi,0x10(%ebp)
80106be3:	83 c4 10             	add    $0x10,%esp
80106be6:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106be9:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80106bec:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106bef:	5b                   	pop    %ebx
80106bf0:	5e                   	pop    %esi
80106bf1:	5f                   	pop    %edi
80106bf2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bf3:	e9 08 db ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106bf8:	83 ec 0c             	sub    $0xc,%esp
80106bfb:	68 35 7b 10 80       	push   $0x80107b35
80106c00:	e8 7b 97 ff ff       	call   80100380 <panic>
...
80106c24:	0f 85 bb 00 00 00    	jne    80106ce5 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
80106c2a:	01 f0                	add    %esi,%eax
80106c2c:	89 f3                	mov    %esi,%ebx
80106c2e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c31:	8b 45 14             	mov    0x14(%ebp),%eax
80106c34:	01 f0                	add    %esi,%eax
80106c36:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106c39:	85 f6                	test   %esi,%esi
80106c3b:	0f 84 87 00 00 00    	je     80106cc8 <loaduvm+0xb8>
80106c41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106c48:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106c4b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106c4e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106c50:	89 c2                	mov    %eax,%edx
80106c52:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106c55:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106c58:	f6 c2 01             	test   $0x1,%dl
80106c5b:	75 13                	jne    80106c70 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106c5d:	83 ec 0c             	sub    $0xc,%esp
80106c60:	68 4f 7b 10 80       	push   $0x80107b4f
80106c65:	e8 16 97 ff ff       	call   80100380 <panic>
80106c6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106c70:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c73:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106c79:	25 fc 0f 00 00       	and    $0xffc,%eax
80106c7e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106c85:	85 c0                	test   %eax,%eax
80106c87:	74 d4                	je     80106c5d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
80106cab:	ff 75 10             	push   0x10(%ebp)
80106cae:	e8 dd ad ff ff       	call   80101a90 <readi>
80106cb3:	83 c4 10             	add    $0x10,%esp
80106cb6:	39 f8                	cmp    %edi,%eax
80106cb8:	75 1e                	jne    80106cd8 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106cba:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106cc0:	89 f0                	mov    %esi,%eax
80106cc2:	29 d8                	sub    %ebx,%eax
80106cc4:	39 c6                	cmp    %eax,%esi
80106cc6:	77 80                	ja     80106c48 <loaduvm+0x38>
}
...
80106ce8:	68 f0 7b 10 80       	push   $0x80107bf0
80106ced:	e8 8e 96 ff ff       	call   80100380 <panic>
...
80106d4b:	e8 10 d9 ff ff       	call   80104660 <memset>
...
80106d79:	76 48                	jbe    80106dc3 <allocuvm+0xc3>
    mem = kalloc();
80106d7b:	e8 00 b9 ff ff       	call   80102680 <kalloc>
...
80106d89:	68 6d 7b 10 80       	push   $0x80107b6d
...
80106deb:	68 85 7b 10 80       	push   $0x80107b85
...
80106e10:	e8 ab b6 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106eae:	e8 0d b6 ff ff       	call   801024c0 <kfree>
...
80106ec3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ec4:	e9 f7 b5 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106ec9:	83 ec 0c             	sub    $0xc,%esp
80106ecc:	68 a1 7b 10 80       	push   $0x80107ba1
...
80106ee5:	e8 96 b7 ff ff       	call   80102680 <kalloc>
...
80106f11:	ff 73 0c             	push   0xc(%ebx)
...
80106f9c:	68 b2 7b 10 80       	push   $0x80107bb2
...
80107012:	68 bc 7b 10 80       	push   $0x80107bbc
...
80107070:	e8 8b d6 ff ff       	call   80104700 <memmove>
...
801070bc:	e8 ff b3 ff ff       	call   801024c0 <kfree>
      goto bad;
...
801070e7:	68 d6 7b 10 80       	push   $0x80107bd6
...
801071a0:	e8 5b d5 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
