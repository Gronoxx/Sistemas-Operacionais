...
80102088:	68 ea 79 10 80       	push   $0x801079ea
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 57 59 10 80 	movl   $0x80105957,0x14(%eax)
  p->context = (struct context*)sp;
...
801038d6:	68 e0 77 10 80       	push   $0x801077e0
...
801039b3:	e8 98 35 00 00       	call   80106f50 <setupkvm>
...
801039d1:	e8 2a 32 00 00       	call   80106c00 <inituvm>
...
80103a3f:	68 10 78 10 80       	push   $0x80107810
80103a44:	50                   	push   %eax
80103a45:	e8 d6 0d 00 00       	call   80104820 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 19 78 10 80 	movl   $0x80107819,(%esp)
...
80103a83:	68 f7 77 10 80       	push   $0x801077f7
...
80103abb:	e8 30 30 00 00       	call   80106af0 <switchuvm>
  return 0;
...
80103ada:	e8 91 32 00 00       	call   80106d70 <allocuvm>
...
80103afa:	e8 a1 33 00 00       	call   80106ea0 <deallocuvm>
...
80103b48:	e8 f3 34 00 00       	call   80107040 <copyuvm>
...
80103c80:	e8 6b 2e 00 00       	call   80106af0 <switchuvm>
...
80103e9d:	68 68 78 10 80       	push   $0x80107868
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 5b 78 10 80       	push   $0x8010785b
...
80103f89:	e8 42 2f 00 00       	call   80106ed0 <freevm>
        p->pid = 0;
...
80103fe0:	68 74 78 10 80       	push   $0x80107874
...
801040e9:	68 7a 78 10 80       	push   $0x8010787a
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 74 78 10 80       	push   $0x80107874
...
801041fb:	68 03 7c 10 80       	push   $0x80107c03
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 8b 78 10 80       	mov    $0x8010788b,%edx
...
80104228:	8b 14 85 ec 78 10 80 	mov    -0x7fef8714(,%eax,4),%edx
      state = "???";
8010422f:	b8 8b 78 10 80       	mov    $0x8010788b,%eax
...
8010423e:	68 8f 78 10 80       	push   $0x8010788f
...
8010427d:	68 e1 72 10 80       	push   $0x801072e1
...
801042aa:	68 04 79 10 80       	push   $0x80107904
...
801044e5:	68 0f 79 10 80       	push   $0x8010790f
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 26 79 10 80       	push   $0x80107926
...
8010455b:	68 2d 79 10 80       	push   $0x8010792d
...
80104650:	68 35 79 10 80       	push   $0x80107935
...
80104a7c:	8b 14 85 60 79 10 80 	mov    -0x7fef86a0(,%eax,4),%edx
...
80104aa8:	68 3d 79 10 80       	push   $0x8010793d
...
80104c04:	68 e0 79 10 80       	push   $0x801079e0
...
80104c1c:	68 df 79 10 80       	push   $0x801079df
...
80104c31:	68 d3 79 10 80       	push   $0x801079d3
...
80104c4f:	68 e2 79 10 80       	push   $0x801079e2
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 c4 79 10 80       	push   $0x801079c4
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 e0 79 10 80       	push   $0x801079e0
...
80105078:	68 df 79 10 80       	push   $0x801079df
...
8010586f:	e8 fc f0 ff ff       	call   80104970 <argptr>

  pde_t *pgdir = myproc()->pgdir;
80105874:	e8 f7 e0 ff ff       	call   80103970 <myproc>
  if(*pde & PTE_P){
...
8010587e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  if(*pde & PTE_P){
80105881:	8b 52 04             	mov    0x4(%edx),%edx
  pde = &pgdir[PDX(va)];
80105884:	89 c1                	mov    %eax,%ecx
80105886:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80105889:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
  pte_t *pte = walkpgdir(pgdir, ptr, 0);

  if (pte == 0 || !(*pte & PTE_P)) {
    return 0;
8010588c:	31 c9                	xor    %ecx,%ecx
  if(*pde & PTE_P){
8010588e:	f6 c2 01             	test   $0x1,%dl
80105891:	74 32                	je     801058c5 <sys_virt2real+0x65>
  return &pgtab[PTX(va)];
80105893:	89 c3                	mov    %eax,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105895:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
8010589b:	c1 eb 0a             	shr    $0xa,%ebx
8010589e:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
801058a4:	8d 94 1a 00 00 00 80 	lea    -0x80000000(%edx,%ebx,1),%edx
  if (pte == 0 || !(*pte & PTE_P)) {
801058ab:	85 d2                	test   %edx,%edx
801058ad:	74 16                	je     801058c5 <sys_virt2real+0x65>
801058af:	8b 12                	mov    (%edx),%edx
801058b1:	f6 c2 01             	test   $0x1,%dl
801058b4:	74 0f                	je     801058c5 <sys_virt2real+0x65>
  }

  return (int)PTE_ADDR(*pte) + ((uint)ptr & 0xFFF);
801058b6:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
801058bc:	25 ff 0f 00 00       	and    $0xfff,%eax
801058c1:	89 d1                	mov    %edx,%ecx
801058c3:	09 c1                	or     %eax,%ecx
}
...
801058d9:	e8 92 e0 ff ff       	call   80103970 <myproc>
    if (!p) {
801058de:	85 c0                	test   %eax,%eax
801058e0:	74 51                	je     80105933 <sys_num_pages+0x63>
    }
...
801058e2:	8b 70 04             	mov    0x4(%eax),%esi
    int count = 0;
801058e5:	31 c9                	xor    %ecx,%ecx
801058e7:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
801058ed:	eb 08                	jmp    801058f7 <sys_num_pages+0x27>
801058ef:	90                   	nop
    for (int i = 0; i < NPDENTRIES; i++) {
801058f0:	83 c6 04             	add    $0x4,%esi
801058f3:	39 fe                	cmp    %edi,%esi
801058f5:	74 32                	je     80105929 <sys_num_pages+0x59>
        if (pgdir[i] & PTE_P) { 
801058f7:	8b 1e                	mov    (%esi),%ebx
801058f9:	f6 c3 01             	test   $0x1,%bl
801058fc:	74 f2                	je     801058f0 <sys_num_pages+0x20>
            pte_t *pte = (pte_t *)P2V(PTE_ADDR(pgdir[i])); 
801058fe:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105904:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
            for (int j = 0; j < NPTENTRIES; j++) {
8010590a:	81 eb 00 f0 ff 7f    	sub    $0x7ffff000,%ebx
                if (pte[j] & PTE_P) { 
80105910:	8b 10                	mov    (%eax),%edx
80105912:	83 e2 01             	and    $0x1,%edx
                    count++; 
80105915:	83 fa 01             	cmp    $0x1,%edx
80105918:	83 d9 ff             	sbb    $0xffffffff,%ecx
            for (int j = 0; j < NPTENTRIES; j++) {
8010591b:	83 c0 04             	add    $0x4,%eax
8010591e:	39 c3                	cmp    %eax,%ebx
80105920:	75 ee                	jne    80105910 <sys_num_pages+0x40>
    for (int i = 0; i < NPDENTRIES; i++) {
80105922:	83 c6 04             	add    $0x4,%esi
80105925:	39 fe                	cmp    %edi,%esi
80105927:	75 ce                	jne    801058f7 <sys_num_pages+0x27>
            }
        }
    }

    return count;
80105929:	83 c4 0c             	add    $0xc,%esp
8010592c:	89 c8                	mov    %ecx,%eax
8010592e:	5b                   	pop    %ebx
8010592f:	5e                   	pop    %esi
80105930:	5f                   	pop    %edi
80105931:	5d                   	pop    %ebp
80105932:	c3                   	ret    
80105933:	83 c4 0c             	add    $0xc,%esp
        return 0; 
...
80105940:	06                   	push   %es
  pushl %fs
80105941:	0f a0                	push   %fs
  pushl %gs
80105943:	0f a8                	push   %gs
  pushal
80105945:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105946:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010594a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010594c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010594e:	54                   	push   %esp
  call trap
8010594f:	e8 cc 00 00 00       	call   80105a20 <trap>
  addl $4, %esp
80105954:	83 c4 04             	add    $0x4,%esp
...
80105957:	61                   	popa   
  popl %gs
80105958:	0f a9                	pop    %gs
  popl %fs
8010595a:	0f a1                	pop    %fs
  popl %es
8010595c:	07                   	pop    %es
  popl %ds
8010595d:	1f                   	pop    %ds
...
80105987:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
8010598e:	08 00 00 8e 
80105992:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
80105999:	80 
8010599a:	c1 ea 10             	shr    $0x10,%edx
8010599d:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
801059a4:	80 
  for(i = 0; i < 256; i++)
...
801059b7:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
801059be:	00 00 ef 
  initlock(&tickslock, "time");
801059c1:	68 25 7a 10 80       	push   $0x80107a25
801059c6:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059cb:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
801059d1:	c1 e8 10             	shr    $0x10,%eax
801059d4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
801059da:	e8 f1 e9 ff ff       	call   801043d0 <initlock>
}
...
801059fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059ff:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105a44:	ff 24 85 cc 7a 10 80 	jmp    *-0x7fef8534(,%eax,4)
...
80105af0:	e8 5b de ff ff       	call   80103950 <cpuid>
...
80105b25:	68 88 7a 10 80       	push   $0x80107a88
80105b2a:	e8 71 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105b2f:	83 c4 20             	add    $0x20,%esp
80105b32:	e8 39 de ff ff       	call   80103970 <myproc>
...
80105b54:	0f 85 3e ff ff ff    	jne    80105a98 <trap+0x78>
    yield();
80105b5a:	e8 91 e4 ff ff       	call   80103ff0 <yield>
...
80105b6f:	e8 dc dd ff ff       	call   80103950 <cpuid>
...
80105bb5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bb8:	e8 a3 ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105bbd:	e8 ae dd ff ff       	call   80103970 <myproc>
...
80105bd3:	5d                   	pop    %ebp
      exit();
80105bd4:	e9 b7 e1 ff ff       	jmp    80103d90 <exit>
...
80105c1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105c20:	e8 2b dd ff ff       	call   80103950 <cpuid>
...
80105c35:	e8 66 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105c3a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105c41:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105c48:	e8 b3 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105c4d:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105c54:	e8 e7 e8 ff ff       	call   80104540 <release>
...
80105c61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105c68:	e8 23 e1 ff ff       	call   80103d90 <exit>
...
80105d37:	74 78                	je     80105db1 <uartinit+0xd1>
  uart = 1;
80105d39:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105d40:	00 00 00 
...
80105d4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d4f:	bf 4c 7b 10 80       	mov    $0x80107b4c,%edi
...
80105e37:	6a 00                	push   $0x0
  jmp alltraps
80105e39:	e9 01 fb ff ff       	jmp    8010593f <alltraps>
...
80105e40:	6a 01                	push   $0x1
  jmp alltraps
80105e42:	e9 f8 fa ff ff       	jmp    8010593f <alltraps>
...
80105e49:	6a 02                	push   $0x2
  jmp alltraps
80105e4b:	e9 ef fa ff ff       	jmp    8010593f <alltraps>
...
80105e52:	6a 03                	push   $0x3
  jmp alltraps
80105e54:	e9 e6 fa ff ff       	jmp    8010593f <alltraps>
...
80105e5b:	6a 04                	push   $0x4
  jmp alltraps
80105e5d:	e9 dd fa ff ff       	jmp    8010593f <alltraps>
...
80105e64:	6a 05                	push   $0x5
  jmp alltraps
80105e66:	e9 d4 fa ff ff       	jmp    8010593f <alltraps>
...
80105e6d:	6a 06                	push   $0x6
  jmp alltraps
80105e6f:	e9 cb fa ff ff       	jmp    8010593f <alltraps>
...
80105e76:	6a 07                	push   $0x7
  jmp alltraps
80105e78:	e9 c2 fa ff ff       	jmp    8010593f <alltraps>
...
80105e7d:	6a 08                	push   $0x8
  jmp alltraps
80105e7f:	e9 bb fa ff ff       	jmp    8010593f <alltraps>
...
80105e86:	6a 09                	push   $0x9
  jmp alltraps
80105e88:	e9 b2 fa ff ff       	jmp    8010593f <alltraps>
...
80105e8d:	6a 0a                	push   $0xa
  jmp alltraps
80105e8f:	e9 ab fa ff ff       	jmp    8010593f <alltraps>
...
80105e94:	6a 0b                	push   $0xb
  jmp alltraps
80105e96:	e9 a4 fa ff ff       	jmp    8010593f <alltraps>
...
80105e9b:	6a 0c                	push   $0xc
  jmp alltraps
80105e9d:	e9 9d fa ff ff       	jmp    8010593f <alltraps>
...
80105ea2:	6a 0d                	push   $0xd
  jmp alltraps
80105ea4:	e9 96 fa ff ff       	jmp    8010593f <alltraps>
...
80105ea9:	6a 0e                	push   $0xe
  jmp alltraps
80105eab:	e9 8f fa ff ff       	jmp    8010593f <alltraps>
...
80105eb2:	6a 0f                	push   $0xf
  jmp alltraps
80105eb4:	e9 86 fa ff ff       	jmp    8010593f <alltraps>
...
80105ebb:	6a 10                	push   $0x10
  jmp alltraps
80105ebd:	e9 7d fa ff ff       	jmp    8010593f <alltraps>
...
80105ec2:	6a 11                	push   $0x11
  jmp alltraps
80105ec4:	e9 76 fa ff ff       	jmp    8010593f <alltraps>
...
80105ecb:	6a 12                	push   $0x12
  jmp alltraps
80105ecd:	e9 6d fa ff ff       	jmp    8010593f <alltraps>
...
80105ed4:	6a 13                	push   $0x13
  jmp alltraps
80105ed6:	e9 64 fa ff ff       	jmp    8010593f <alltraps>
...
80105edd:	6a 14                	push   $0x14
  jmp alltraps
80105edf:	e9 5b fa ff ff       	jmp    8010593f <alltraps>
...
80105ee6:	6a 15                	push   $0x15
  jmp alltraps
80105ee8:	e9 52 fa ff ff       	jmp    8010593f <alltraps>
...
80105eef:	6a 16                	push   $0x16
  jmp alltraps
80105ef1:	e9 49 fa ff ff       	jmp    8010593f <alltraps>
...
80105ef8:	6a 17                	push   $0x17
  jmp alltraps
80105efa:	e9 40 fa ff ff       	jmp    8010593f <alltraps>
...
80105f01:	6a 18                	push   $0x18
  jmp alltraps
80105f03:	e9 37 fa ff ff       	jmp    8010593f <alltraps>
...
80105f0a:	6a 19                	push   $0x19
  jmp alltraps
80105f0c:	e9 2e fa ff ff       	jmp    8010593f <alltraps>
...
80105f13:	6a 1a                	push   $0x1a
  jmp alltraps
80105f15:	e9 25 fa ff ff       	jmp    8010593f <alltraps>
...
80105f1c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f1e:	e9 1c fa ff ff       	jmp    8010593f <alltraps>
...
80105f25:	6a 1c                	push   $0x1c
  jmp alltraps
80105f27:	e9 13 fa ff ff       	jmp    8010593f <alltraps>
...
80105f2e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f30:	e9 0a fa ff ff       	jmp    8010593f <alltraps>
...
80105f37:	6a 1e                	push   $0x1e
  jmp alltraps
80105f39:	e9 01 fa ff ff       	jmp    8010593f <alltraps>
...
80105f40:	6a 1f                	push   $0x1f
  jmp alltraps
80105f42:	e9 f8 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f49:	6a 20                	push   $0x20
  jmp alltraps
80105f4b:	e9 ef f9 ff ff       	jmp    8010593f <alltraps>
...
80105f52:	6a 21                	push   $0x21
  jmp alltraps
80105f54:	e9 e6 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f5b:	6a 22                	push   $0x22
  jmp alltraps
80105f5d:	e9 dd f9 ff ff       	jmp    8010593f <alltraps>
...
80105f64:	6a 23                	push   $0x23
  jmp alltraps
80105f66:	e9 d4 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f6d:	6a 24                	push   $0x24
  jmp alltraps
80105f6f:	e9 cb f9 ff ff       	jmp    8010593f <alltraps>
...
80105f76:	6a 25                	push   $0x25
  jmp alltraps
80105f78:	e9 c2 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f7f:	6a 26                	push   $0x26
  jmp alltraps
80105f81:	e9 b9 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f88:	6a 27                	push   $0x27
  jmp alltraps
80105f8a:	e9 b0 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f91:	6a 28                	push   $0x28
  jmp alltraps
80105f93:	e9 a7 f9 ff ff       	jmp    8010593f <alltraps>
...
80105f9a:	6a 29                	push   $0x29
  jmp alltraps
80105f9c:	e9 9e f9 ff ff       	jmp    8010593f <alltraps>
...
80105fa3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fa5:	e9 95 f9 ff ff       	jmp    8010593f <alltraps>
...
80105fac:	6a 2b                	push   $0x2b
  jmp alltraps
80105fae:	e9 8c f9 ff ff       	jmp    8010593f <alltraps>
...
80105fb5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fb7:	e9 83 f9 ff ff       	jmp    8010593f <alltraps>
...
80105fbe:	6a 2d                	push   $0x2d
  jmp alltraps
80105fc0:	e9 7a f9 ff ff       	jmp    8010593f <alltraps>
...
80105fc7:	6a 2e                	push   $0x2e
  jmp alltraps
80105fc9:	e9 71 f9 ff ff       	jmp    8010593f <alltraps>
...
80105fd0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fd2:	e9 68 f9 ff ff       	jmp    8010593f <alltraps>
...
80105fd9:	6a 30                	push   $0x30
  jmp alltraps
80105fdb:	e9 5f f9 ff ff       	jmp    8010593f <alltraps>
...
80105fe2:	6a 31                	push   $0x31
  jmp alltraps
80105fe4:	e9 56 f9 ff ff       	jmp    8010593f <alltraps>
...
80105feb:	6a 32                	push   $0x32
  jmp alltraps
80105fed:	e9 4d f9 ff ff       	jmp    8010593f <alltraps>
...
80105ff4:	6a 33                	push   $0x33
  jmp alltraps
80105ff6:	e9 44 f9 ff ff       	jmp    8010593f <alltraps>
...
80105ffd:	6a 34                	push   $0x34
  jmp alltraps
80105fff:	e9 3b f9 ff ff       	jmp    8010593f <alltraps>
...
80106006:	6a 35                	push   $0x35
  jmp alltraps
80106008:	e9 32 f9 ff ff       	jmp    8010593f <alltraps>
...
8010600f:	6a 36                	push   $0x36
  jmp alltraps
80106011:	e9 29 f9 ff ff       	jmp    8010593f <alltraps>
...
80106018:	6a 37                	push   $0x37
  jmp alltraps
8010601a:	e9 20 f9 ff ff       	jmp    8010593f <alltraps>
...
80106021:	6a 38                	push   $0x38
  jmp alltraps
80106023:	e9 17 f9 ff ff       	jmp    8010593f <alltraps>
...
8010602a:	6a 39                	push   $0x39
  jmp alltraps
8010602c:	e9 0e f9 ff ff       	jmp    8010593f <alltraps>
...
80106033:	6a 3a                	push   $0x3a
  jmp alltraps
80106035:	e9 05 f9 ff ff       	jmp    8010593f <alltraps>
...
8010603c:	6a 3b                	push   $0x3b
  jmp alltraps
8010603e:	e9 fc f8 ff ff       	jmp    8010593f <alltraps>
...
80106045:	6a 3c                	push   $0x3c
  jmp alltraps
80106047:	e9 f3 f8 ff ff       	jmp    8010593f <alltraps>
...
8010604e:	6a 3d                	push   $0x3d
  jmp alltraps
80106050:	e9 ea f8 ff ff       	jmp    8010593f <alltraps>
...
80106057:	6a 3e                	push   $0x3e
  jmp alltraps
80106059:	e9 e1 f8 ff ff       	jmp    8010593f <alltraps>
...
80106060:	6a 3f                	push   $0x3f
  jmp alltraps
80106062:	e9 d8 f8 ff ff       	jmp    8010593f <alltraps>
...
80106069:	6a 40                	push   $0x40
  jmp alltraps
8010606b:	e9 cf f8 ff ff       	jmp    8010593f <alltraps>
...
80106072:	6a 41                	push   $0x41
  jmp alltraps
80106074:	e9 c6 f8 ff ff       	jmp    8010593f <alltraps>
...
8010607b:	6a 42                	push   $0x42
  jmp alltraps
8010607d:	e9 bd f8 ff ff       	jmp    8010593f <alltraps>
...
80106084:	6a 43                	push   $0x43
  jmp alltraps
80106086:	e9 b4 f8 ff ff       	jmp    8010593f <alltraps>
...
8010608d:	6a 44                	push   $0x44
  jmp alltraps
8010608f:	e9 ab f8 ff ff       	jmp    8010593f <alltraps>
...
80106096:	6a 45                	push   $0x45
  jmp alltraps
80106098:	e9 a2 f8 ff ff       	jmp    8010593f <alltraps>
...
8010609f:	6a 46                	push   $0x46
  jmp alltraps
801060a1:	e9 99 f8 ff ff       	jmp    8010593f <alltraps>
...
801060a8:	6a 47                	push   $0x47
  jmp alltraps
801060aa:	e9 90 f8 ff ff       	jmp    8010593f <alltraps>
...
801060b1:	6a 48                	push   $0x48
  jmp alltraps
801060b3:	e9 87 f8 ff ff       	jmp    8010593f <alltraps>
...
801060ba:	6a 49                	push   $0x49
  jmp alltraps
801060bc:	e9 7e f8 ff ff       	jmp    8010593f <alltraps>
...
801060c3:	6a 4a                	push   $0x4a
  jmp alltraps
801060c5:	e9 75 f8 ff ff       	jmp    8010593f <alltraps>
...
801060cc:	6a 4b                	push   $0x4b
  jmp alltraps
801060ce:	e9 6c f8 ff ff       	jmp    8010593f <alltraps>
...
801060d5:	6a 4c                	push   $0x4c
  jmp alltraps
801060d7:	e9 63 f8 ff ff       	jmp    8010593f <alltraps>
...
801060de:	6a 4d                	push   $0x4d
  jmp alltraps
801060e0:	e9 5a f8 ff ff       	jmp    8010593f <alltraps>
...
801060e7:	6a 4e                	push   $0x4e
  jmp alltraps
801060e9:	e9 51 f8 ff ff       	jmp    8010593f <alltraps>
...
801060f0:	6a 4f                	push   $0x4f
  jmp alltraps
801060f2:	e9 48 f8 ff ff       	jmp    8010593f <alltraps>
...
801060f9:	6a 50                	push   $0x50
  jmp alltraps
801060fb:	e9 3f f8 ff ff       	jmp    8010593f <alltraps>
...
80106102:	6a 51                	push   $0x51
  jmp alltraps
80106104:	e9 36 f8 ff ff       	jmp    8010593f <alltraps>
...
8010610b:	6a 52                	push   $0x52
  jmp alltraps
8010610d:	e9 2d f8 ff ff       	jmp    8010593f <alltraps>
...
80106114:	6a 53                	push   $0x53
  jmp alltraps
80106116:	e9 24 f8 ff ff       	jmp    8010593f <alltraps>
...
8010611d:	6a 54                	push   $0x54
  jmp alltraps
8010611f:	e9 1b f8 ff ff       	jmp    8010593f <alltraps>
...
80106126:	6a 55                	push   $0x55
  jmp alltraps
80106128:	e9 12 f8 ff ff       	jmp    8010593f <alltraps>
...
8010612f:	6a 56                	push   $0x56
  jmp alltraps
80106131:	e9 09 f8 ff ff       	jmp    8010593f <alltraps>
...
80106138:	6a 57                	push   $0x57
  jmp alltraps
8010613a:	e9 00 f8 ff ff       	jmp    8010593f <alltraps>
...
80106141:	6a 58                	push   $0x58
  jmp alltraps
80106143:	e9 f7 f7 ff ff       	jmp    8010593f <alltraps>
...
8010614a:	6a 59                	push   $0x59
  jmp alltraps
8010614c:	e9 ee f7 ff ff       	jmp    8010593f <alltraps>
...
80106153:	6a 5a                	push   $0x5a
  jmp alltraps
80106155:	e9 e5 f7 ff ff       	jmp    8010593f <alltraps>
...
8010615c:	6a 5b                	push   $0x5b
  jmp alltraps
8010615e:	e9 dc f7 ff ff       	jmp    8010593f <alltraps>
...
80106165:	6a 5c                	push   $0x5c
  jmp alltraps
80106167:	e9 d3 f7 ff ff       	jmp    8010593f <alltraps>
...
8010616e:	6a 5d                	push   $0x5d
  jmp alltraps
80106170:	e9 ca f7 ff ff       	jmp    8010593f <alltraps>
...
80106177:	6a 5e                	push   $0x5e
  jmp alltraps
80106179:	e9 c1 f7 ff ff       	jmp    8010593f <alltraps>
...
80106180:	6a 5f                	push   $0x5f
  jmp alltraps
80106182:	e9 b8 f7 ff ff       	jmp    8010593f <alltraps>
...
80106189:	6a 60                	push   $0x60
  jmp alltraps
8010618b:	e9 af f7 ff ff       	jmp    8010593f <alltraps>
...
80106192:	6a 61                	push   $0x61
  jmp alltraps
80106194:	e9 a6 f7 ff ff       	jmp    8010593f <alltraps>
...
8010619b:	6a 62                	push   $0x62
  jmp alltraps
8010619d:	e9 9d f7 ff ff       	jmp    8010593f <alltraps>
...
801061a4:	6a 63                	push   $0x63
  jmp alltraps
801061a6:	e9 94 f7 ff ff       	jmp    8010593f <alltraps>
...
801061ad:	6a 64                	push   $0x64
  jmp alltraps
801061af:	e9 8b f7 ff ff       	jmp    8010593f <alltraps>
...
801061b6:	6a 65                	push   $0x65
  jmp alltraps
801061b8:	e9 82 f7 ff ff       	jmp    8010593f <alltraps>
...
801061bf:	6a 66                	push   $0x66
  jmp alltraps
801061c1:	e9 79 f7 ff ff       	jmp    8010593f <alltraps>
...
801061c8:	6a 67                	push   $0x67
  jmp alltraps
801061ca:	e9 70 f7 ff ff       	jmp    8010593f <alltraps>
...
801061d1:	6a 68                	push   $0x68
  jmp alltraps
801061d3:	e9 67 f7 ff ff       	jmp    8010593f <alltraps>
...
801061da:	6a 69                	push   $0x69
  jmp alltraps
801061dc:	e9 5e f7 ff ff       	jmp    8010593f <alltraps>
...
801061e3:	6a 6a                	push   $0x6a
  jmp alltraps
801061e5:	e9 55 f7 ff ff       	jmp    8010593f <alltraps>
...
801061ec:	6a 6b                	push   $0x6b
  jmp alltraps
801061ee:	e9 4c f7 ff ff       	jmp    8010593f <alltraps>
...
801061f5:	6a 6c                	push   $0x6c
  jmp alltraps
801061f7:	e9 43 f7 ff ff       	jmp    8010593f <alltraps>
...
801061fe:	6a 6d                	push   $0x6d
  jmp alltraps
80106200:	e9 3a f7 ff ff       	jmp    8010593f <alltraps>
...
80106207:	6a 6e                	push   $0x6e
  jmp alltraps
80106209:	e9 31 f7 ff ff       	jmp    8010593f <alltraps>
...
80106210:	6a 6f                	push   $0x6f
  jmp alltraps
80106212:	e9 28 f7 ff ff       	jmp    8010593f <alltraps>
...
80106219:	6a 70                	push   $0x70
  jmp alltraps
8010621b:	e9 1f f7 ff ff       	jmp    8010593f <alltraps>
...
80106222:	6a 71                	push   $0x71
  jmp alltraps
80106224:	e9 16 f7 ff ff       	jmp    8010593f <alltraps>
...
8010622b:	6a 72                	push   $0x72
  jmp alltraps
8010622d:	e9 0d f7 ff ff       	jmp    8010593f <alltraps>
...
80106234:	6a 73                	push   $0x73
  jmp alltraps
80106236:	e9 04 f7 ff ff       	jmp    8010593f <alltraps>
...
8010623d:	6a 74                	push   $0x74
  jmp alltraps
8010623f:	e9 fb f6 ff ff       	jmp    8010593f <alltraps>
...
80106246:	6a 75                	push   $0x75
  jmp alltraps
80106248:	e9 f2 f6 ff ff       	jmp    8010593f <alltraps>
...
8010624f:	6a 76                	push   $0x76
  jmp alltraps
80106251:	e9 e9 f6 ff ff       	jmp    8010593f <alltraps>
...
80106258:	6a 77                	push   $0x77
  jmp alltraps
8010625a:	e9 e0 f6 ff ff       	jmp    8010593f <alltraps>
...
80106261:	6a 78                	push   $0x78
  jmp alltraps
80106263:	e9 d7 f6 ff ff       	jmp    8010593f <alltraps>
...
8010626a:	6a 79                	push   $0x79
  jmp alltraps
8010626c:	e9 ce f6 ff ff       	jmp    8010593f <alltraps>
...
80106273:	6a 7a                	push   $0x7a
  jmp alltraps
80106275:	e9 c5 f6 ff ff       	jmp    8010593f <alltraps>
...
8010627c:	6a 7b                	push   $0x7b
  jmp alltraps
8010627e:	e9 bc f6 ff ff       	jmp    8010593f <alltraps>
...
80106285:	6a 7c                	push   $0x7c
  jmp alltraps
80106287:	e9 b3 f6 ff ff       	jmp    8010593f <alltraps>
...
8010628e:	6a 7d                	push   $0x7d
  jmp alltraps
80106290:	e9 aa f6 ff ff       	jmp    8010593f <alltraps>
...
80106297:	6a 7e                	push   $0x7e
  jmp alltraps
80106299:	e9 a1 f6 ff ff       	jmp    8010593f <alltraps>
...
801062a0:	6a 7f                	push   $0x7f
  jmp alltraps
801062a2:	e9 98 f6 ff ff       	jmp    8010593f <alltraps>
...
801062a9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062ae:	e9 8c f6 ff ff       	jmp    8010593f <alltraps>
...
801062b5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062ba:	e9 80 f6 ff ff       	jmp    8010593f <alltraps>
...
801062c1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801062c6:	e9 74 f6 ff ff       	jmp    8010593f <alltraps>
...
801062cd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801062d2:	e9 68 f6 ff ff       	jmp    8010593f <alltraps>
...
801062d9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801062de:	e9 5c f6 ff ff       	jmp    8010593f <alltraps>
...
801062e5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801062ea:	e9 50 f6 ff ff       	jmp    8010593f <alltraps>
...
801062f1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801062f6:	e9 44 f6 ff ff       	jmp    8010593f <alltraps>
...
801062fd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106302:	e9 38 f6 ff ff       	jmp    8010593f <alltraps>
...
80106309:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010630e:	e9 2c f6 ff ff       	jmp    8010593f <alltraps>
...
80106315:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010631a:	e9 20 f6 ff ff       	jmp    8010593f <alltraps>
...
80106321:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106326:	e9 14 f6 ff ff       	jmp    8010593f <alltraps>
...
8010632d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106332:	e9 08 f6 ff ff       	jmp    8010593f <alltraps>
...
80106339:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010633e:	e9 fc f5 ff ff       	jmp    8010593f <alltraps>
...
80106345:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010634a:	e9 f0 f5 ff ff       	jmp    8010593f <alltraps>
...
80106351:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106356:	e9 e4 f5 ff ff       	jmp    8010593f <alltraps>
...
8010635d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106362:	e9 d8 f5 ff ff       	jmp    8010593f <alltraps>
...
80106369:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010636e:	e9 cc f5 ff ff       	jmp    8010593f <alltraps>
...
80106375:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010637a:	e9 c0 f5 ff ff       	jmp    8010593f <alltraps>
...
80106381:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106386:	e9 b4 f5 ff ff       	jmp    8010593f <alltraps>
...
8010638d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106392:	e9 a8 f5 ff ff       	jmp    8010593f <alltraps>
...
80106399:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010639e:	e9 9c f5 ff ff       	jmp    8010593f <alltraps>
...
801063a5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063aa:	e9 90 f5 ff ff       	jmp    8010593f <alltraps>
...
801063b1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063b6:	e9 84 f5 ff ff       	jmp    8010593f <alltraps>
...
801063bd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801063c2:	e9 78 f5 ff ff       	jmp    8010593f <alltraps>
...
801063c9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801063ce:	e9 6c f5 ff ff       	jmp    8010593f <alltraps>
...
801063d5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801063da:	e9 60 f5 ff ff       	jmp    8010593f <alltraps>
...
801063e1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801063e6:	e9 54 f5 ff ff       	jmp    8010593f <alltraps>
...
801063ed:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801063f2:	e9 48 f5 ff ff       	jmp    8010593f <alltraps>
...
801063f9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801063fe:	e9 3c f5 ff ff       	jmp    8010593f <alltraps>
...
80106405:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010640a:	e9 30 f5 ff ff       	jmp    8010593f <alltraps>
...
80106411:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106416:	e9 24 f5 ff ff       	jmp    8010593f <alltraps>
...
8010641d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106422:	e9 18 f5 ff ff       	jmp    8010593f <alltraps>
...
80106429:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010642e:	e9 0c f5 ff ff       	jmp    8010593f <alltraps>
...
80106435:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010643a:	e9 00 f5 ff ff       	jmp    8010593f <alltraps>
...
80106441:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106446:	e9 f4 f4 ff ff       	jmp    8010593f <alltraps>
...
8010644d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106452:	e9 e8 f4 ff ff       	jmp    8010593f <alltraps>
...
80106459:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010645e:	e9 dc f4 ff ff       	jmp    8010593f <alltraps>
...
80106465:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010646a:	e9 d0 f4 ff ff       	jmp    8010593f <alltraps>
...
80106471:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106476:	e9 c4 f4 ff ff       	jmp    8010593f <alltraps>
...
8010647d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106482:	e9 b8 f4 ff ff       	jmp    8010593f <alltraps>
...
80106489:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010648e:	e9 ac f4 ff ff       	jmp    8010593f <alltraps>
...
80106495:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010649a:	e9 a0 f4 ff ff       	jmp    8010593f <alltraps>
...
801064a1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064a6:	e9 94 f4 ff ff       	jmp    8010593f <alltraps>
...
801064ad:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064b2:	e9 88 f4 ff ff       	jmp    8010593f <alltraps>
...
801064b9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064be:	e9 7c f4 ff ff       	jmp    8010593f <alltraps>
...
801064c5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801064ca:	e9 70 f4 ff ff       	jmp    8010593f <alltraps>
...
801064d1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801064d6:	e9 64 f4 ff ff       	jmp    8010593f <alltraps>
...
801064dd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801064e2:	e9 58 f4 ff ff       	jmp    8010593f <alltraps>
...
801064e9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801064ee:	e9 4c f4 ff ff       	jmp    8010593f <alltraps>
...
801064f5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801064fa:	e9 40 f4 ff ff       	jmp    8010593f <alltraps>
...
80106501:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106506:	e9 34 f4 ff ff       	jmp    8010593f <alltraps>
...
8010650d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106512:	e9 28 f4 ff ff       	jmp    8010593f <alltraps>
...
80106519:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010651e:	e9 1c f4 ff ff       	jmp    8010593f <alltraps>
...
80106525:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010652a:	e9 10 f4 ff ff       	jmp    8010593f <alltraps>
...
80106531:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106536:	e9 04 f4 ff ff       	jmp    8010593f <alltraps>
...
8010653d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106542:	e9 f8 f3 ff ff       	jmp    8010593f <alltraps>
...
80106549:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010654e:	e9 ec f3 ff ff       	jmp    8010593f <alltraps>
...
80106555:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010655a:	e9 e0 f3 ff ff       	jmp    8010593f <alltraps>
...
80106561:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106566:	e9 d4 f3 ff ff       	jmp    8010593f <alltraps>
...
8010656d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106572:	e9 c8 f3 ff ff       	jmp    8010593f <alltraps>
...
80106579:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010657e:	e9 bc f3 ff ff       	jmp    8010593f <alltraps>
...
80106585:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010658a:	e9 b0 f3 ff ff       	jmp    8010593f <alltraps>
...
80106591:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106596:	e9 a4 f3 ff ff       	jmp    8010593f <alltraps>
...
8010659d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065a2:	e9 98 f3 ff ff       	jmp    8010593f <alltraps>
...
801065a9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065ae:	e9 8c f3 ff ff       	jmp    8010593f <alltraps>
...
801065b5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065ba:	e9 80 f3 ff ff       	jmp    8010593f <alltraps>
...
801065c1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801065c6:	e9 74 f3 ff ff       	jmp    8010593f <alltraps>
...
801065cd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801065d2:	e9 68 f3 ff ff       	jmp    8010593f <alltraps>
...
801065d9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801065de:	e9 5c f3 ff ff       	jmp    8010593f <alltraps>
...
801065e5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801065ea:	e9 50 f3 ff ff       	jmp    8010593f <alltraps>
...
801065f1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801065f6:	e9 44 f3 ff ff       	jmp    8010593f <alltraps>
...
801065fd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106602:	e9 38 f3 ff ff       	jmp    8010593f <alltraps>
...
80106609:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010660e:	e9 2c f3 ff ff       	jmp    8010593f <alltraps>
...
80106615:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010661a:	e9 20 f3 ff ff       	jmp    8010593f <alltraps>
...
80106621:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106626:	e9 14 f3 ff ff       	jmp    8010593f <alltraps>
...
8010662d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106632:	e9 08 f3 ff ff       	jmp    8010593f <alltraps>
...
80106639:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010663e:	e9 fc f2 ff ff       	jmp    8010593f <alltraps>
...
80106645:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010664a:	e9 f0 f2 ff ff       	jmp    8010593f <alltraps>
...
80106651:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106656:	e9 e4 f2 ff ff       	jmp    8010593f <alltraps>
...
8010665d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106662:	e9 d8 f2 ff ff       	jmp    8010593f <alltraps>
...
80106669:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010666e:	e9 cc f2 ff ff       	jmp    8010593f <alltraps>
...
80106675:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010667a:	e9 c0 f2 ff ff       	jmp    8010593f <alltraps>
...
80106681:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106686:	e9 b4 f2 ff ff       	jmp    8010593f <alltraps>
...
8010668d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106692:	e9 a8 f2 ff ff       	jmp    8010593f <alltraps>
...
80106699:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010669e:	e9 9c f2 ff ff       	jmp    8010593f <alltraps>
...
801066a5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066aa:	e9 90 f2 ff ff       	jmp    8010593f <alltraps>
...
801066b1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066b6:	e9 84 f2 ff ff       	jmp    8010593f <alltraps>
...
801066bd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801066c2:	e9 78 f2 ff ff       	jmp    8010593f <alltraps>
...
801066c9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801066ce:	e9 6c f2 ff ff       	jmp    8010593f <alltraps>
...
801066d5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801066da:	e9 60 f2 ff ff       	jmp    8010593f <alltraps>
...
801066e1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801066e6:	e9 54 f2 ff ff       	jmp    8010593f <alltraps>
...
801066ed:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801066f2:	e9 48 f2 ff ff       	jmp    8010593f <alltraps>
...
801066f9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801066fe:	e9 3c f2 ff ff       	jmp    8010593f <alltraps>
...
80106705:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010670a:	e9 30 f2 ff ff       	jmp    8010593f <alltraps>
...
80106711:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106716:	e9 24 f2 ff ff       	jmp    8010593f <alltraps>
...
8010671d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106722:	e9 18 f2 ff ff       	jmp    8010593f <alltraps>
...
80106729:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010672e:	e9 0c f2 ff ff       	jmp    8010593f <alltraps>
...
80106735:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010673a:	e9 00 f2 ff ff       	jmp    8010593f <alltraps>
...
80106741:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106746:	e9 f4 f1 ff ff       	jmp    8010593f <alltraps>
...
8010674d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106752:	e9 e8 f1 ff ff       	jmp    8010593f <alltraps>
...
80106759:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010675e:	e9 dc f1 ff ff       	jmp    8010593f <alltraps>
...
80106765:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010676a:	e9 d0 f1 ff ff       	jmp    8010593f <alltraps>
...
80106771:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106776:	e9 c4 f1 ff ff       	jmp    8010593f <alltraps>
...
8010677d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106782:	e9 b8 f1 ff ff       	jmp    8010593f <alltraps>
...
80106789:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010678e:	e9 ac f1 ff ff       	jmp    8010593f <alltraps>
...
80106795:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010679a:	e9 a0 f1 ff ff       	jmp    8010593f <alltraps>
...
801067a1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067a6:	e9 94 f1 ff ff       	jmp    8010593f <alltraps>
...
801067ad:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067b2:	e9 88 f1 ff ff       	jmp    8010593f <alltraps>
...
801067b9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067be:	e9 7c f1 ff ff       	jmp    8010593f <alltraps>
...
801067c5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801067ca:	e9 70 f1 ff ff       	jmp    8010593f <alltraps>
...
801067d1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801067d6:	e9 64 f1 ff ff       	jmp    8010593f <alltraps>
...
801067dd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801067e2:	e9 58 f1 ff ff       	jmp    8010593f <alltraps>
...
801067e9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801067ee:	e9 4c f1 ff ff       	jmp    8010593f <alltraps>
...
801067f5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801067fa:	e9 40 f1 ff ff       	jmp    8010593f <alltraps>
...
80106801:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106806:	e9 34 f1 ff ff       	jmp    8010593f <alltraps>
...
8010680d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106812:	e9 28 f1 ff ff       	jmp    8010593f <alltraps>
...
80106819:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010681e:	e9 1c f1 ff ff       	jmp    8010593f <alltraps>
...
80106825:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010682a:	e9 10 f1 ff ff       	jmp    8010593f <alltraps>
...
80106831:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106836:	e9 04 f1 ff ff       	jmp    8010593f <alltraps>
...
8010683d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106842:	e9 f8 f0 ff ff       	jmp    8010593f <alltraps>
...
80106849:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010684e:	e9 ec f0 ff ff       	jmp    8010593f <alltraps>
...
80106855:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010685a:	e9 e0 f0 ff ff       	jmp    8010593f <alltraps>
...
80106861:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106866:	e9 d4 f0 ff ff       	jmp    8010593f <alltraps>
...
8010686d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106872:	e9 c8 f0 ff ff       	jmp    8010593f <alltraps>
...
80106879:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010687e:	e9 bc f0 ff ff       	jmp    8010593f <alltraps>
...
80106885:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010688a:	e9 b0 f0 ff ff       	jmp    8010593f <alltraps>
...
80106891:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106896:	e9 a4 f0 ff ff       	jmp    8010593f <alltraps>
...
8010689d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068a2:	e9 98 f0 ff ff       	jmp    8010593f <alltraps>
...
80106a3d:	68 54 7b 10 80       	push   $0x80107b54
...
80106a53:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a56:	e8 f5 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106ae0:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106b14:	0f 84 c2 00 00 00    	je     80106bdc <switchuvm+0xec>
  pushcli();
80106b1a:	e8 31 d9 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b1f:	e8 cc cd ff ff       	call   801038f0 <mycpu>
80106b24:	89 c3                	mov    %eax,%ebx
80106b26:	e8 c5 cd ff ff       	call   801038f0 <mycpu>
...
80106b38:	e8 b3 cd ff ff       	call   801038f0 <mycpu>
...
80106b81:	e8 6a cd ff ff       	call   801038f0 <mycpu>
...
80106b9f:	e8 4c cd ff ff       	call   801038f0 <mycpu>
80106ba4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ba7:	e8 44 cd ff ff       	call   801038f0 <mycpu>
...
80106c2f:	e8 2c da ff ff       	call   80104660 <memset>
...
80106c62:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c63:	e9 98 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c68:	83 ec 0c             	sub    $0xc,%esp
80106c6b:	68 99 7b 10 80       	push   $0x80107b99
...
80106cd0:	68 b3 7b 10 80       	push   $0x80107bb3
...
80106d58:	68 54 7c 10 80       	push   $0x80107c54
...
80106dbb:	e8 a0 d8 ff ff       	call   80104660 <memset>
...
80106df9:	68 d1 7b 10 80       	push   $0x80107bd1
...
80106e5b:	68 e9 7b 10 80       	push   $0x80107be9
...
80106f3c:	68 05 7c 10 80       	push   $0x80107c05
...
80106f70:	e8 eb d6 ff ff       	call   80104660 <memset>
...
80106fdb:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010700c:	68 16 7c 10 80       	push   $0x80107c16
...
80107082:	68 20 7c 10 80       	push   $0x80107c20
...
801070e0:	e8 1b d6 ff ff       	call   80104700 <memmove>
...
80107157:	68 3a 7c 10 80       	push   $0x80107c3a
...
80107210:	e8 eb d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
